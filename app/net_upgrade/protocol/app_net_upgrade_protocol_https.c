...
extern UpgradeProtocol https_ops;

int https_get_upgrade_info(char *url)
{
...
static int https_upgrade_file_get(char *url)
{
...
UpgradeProtocol https_ops =
{
    .protocol = "https",
    .cfg_get = https_get_upgrade_info,
    .cfg_parse = config_file_parse,
    .upg_file_get = https_upgrade_file_get,
