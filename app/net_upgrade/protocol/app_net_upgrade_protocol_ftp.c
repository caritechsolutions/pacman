...
extern UpgradeProtocol ftp_ops;

gxapps_ret_t ftp_get_upgrade_info(char *url)
{
...
static int ftp_upgrade_file_get(char *url)
{
...
UpgradeProtocol ftp_ops =
{
    .protocol = "ftp",
    .cfg_get = ftp_get_upgrade_info,
    .cfg_parse = config_file_parse,
    .upg_file_get = ftp_upgrade_file_get,
