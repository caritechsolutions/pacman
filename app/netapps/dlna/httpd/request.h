...
public:
	...
	/////////////////////////////////////////////////////////////////////////////////////
        bool SetSocketWriteTimeout(int ms);
        bool SocketWriteDataNonblock( char const * data, long length, volatile int &exit_flag, int retry_times );
	/////////////////////////////////////////////////////////////////////////////////////
