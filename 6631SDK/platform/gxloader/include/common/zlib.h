...
extern int compress (Byte *dest, uLong *destLen, const Byte *source, uLong sourceLen);

extern uLong compressBound (uLong sourceLen);

extern int uncompress (Byte *dest, uLong *destLen, const Byte *source, uLong sourceLen);
