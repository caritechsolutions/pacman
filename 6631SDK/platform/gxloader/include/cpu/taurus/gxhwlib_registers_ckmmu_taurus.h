#ifndef __EMHWLIB_REGISTERS_CSKY_TAURUS_H__
#define __EMHWLIB_REGISTERS_CSKY_TAURUS_H__
...
#define DEMUX_BUFFER_READY       (REG_BASE_DEMUX + 0x47f8)
...
#define DDR_INFO_GET_NO_MMU() (OTP_GET_CFG_DATA_NOMMU(27, 0x1F) \
	| (OTP_GET_CFG_DATA_NOMMU(32, 0x7) << 5))

#define DDR_INFO_GET() (OTP_GET_CFG_DATA(27, 0x1F) \
	| (OTP_GET_CFG_DATA(32, 0x7) << 5))
