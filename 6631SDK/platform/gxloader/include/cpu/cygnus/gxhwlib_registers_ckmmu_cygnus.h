#ifndef __EMHWLIB_REGISTERS_CSKY_CYGNUS_H__
#define __EMHWLIB_REGISTERS_CSKY_CYGNUS_H__
...
#define REG_INTERNAL_FUNSEL      (0x0030a480 + GX_REG_VIRTUAL_BASE1)
...
//------ USB PHY
#define USB_PHY_BASE             (0x00702000 + GX_REG_VIRTUAL_BASE1)
...
//--SPI offset
#define GX_REG_BASE_SPI1_SELECT  (REG_BASE_CHIPCONFIG + 0x900)
#define GX_REG_BASE_SPI1_CS      (REG_BASE_CHIPCONFIG + 0x904)
...
#define FLASH_ENCRYPT_ENABLE     (113)
