#ifndef __EMHWLIB_REGISTERS_CSKY_GX6605S_H__
#define __EMHWLIB_REGISTERS_CSKY_GX6605S_H__
...
//------DW UART
#define REG_BASE_UART2           (0x00403000 + GX_REG_VIRTUAL_BASE1)
#define REG_BASE_UART3           (0x00413000 + GX_REG_VIRTUAL_BASE1)

//---smartcard
#define REG_BASE_SMARTCARD0       (0x00207000 + GX_REG_VIRTUAL_BASE1)
#define REG_BASE_SMARTCARD1       (0x00D00000 + GX_REG_VIRTUAL_BASE1)
...
//PMU
#define REG_BASE_PMU             (0x00100000 + GX_REG_VIRTUAL_BASE1)
#define PMU_DPRAM_SIZE           (16*1024)
#define PMU_FW_DATA_SIZE         0x80
...
#define ADVANCE_CONFIG           (REG_BASE_ADVANCE + 0x0c)
#define MASK_ADVANCE_BOOT        (0x1)
#define BIT_ADVANCE_BOOT         (0)
//#define REG_ENABLE_NDS_BOOT    (((*(volatile unsigned int*)(ADVANCE_CONFIG))>>BIT_ADVANCE_BOOT)&MASK_ADVANCE_BOOT)
#define REG_ENABLE_NDS_BOOT      (( ( sec_read(ADVANCE_CONFIG,65535) ) >>BIT_ADVANCE_BOOT)&MASK_ADVANCE_BOOT)

#define MASK_CHIPSET_SUB_TYPE    (0x7)
#define BIT_CHIPSET_SUB_TYPE     (11)
//#define REG_CHIP_6605S_PROBE     (((*(volatile unsigned int*)(ADVANCE_CONFIG))>>BIT_CHIPSET_SUB_TYPE)&MASK_CHIPSET_SUB_TYPE)
#define REG_CHIP_6605S_PROBE     (((sec_read(ADVANCE_CONFIG,65535))>>BIT_CHIPSET_SUB_TYPE)&MASK_CHIPSET_SUB_TYPE)
