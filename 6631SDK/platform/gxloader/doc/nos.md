...
编译生成的固件：
```
$ ./build sirius 6613H2-NNE lib
output/libnos.a:	2055354
copy lib & include file
```
...
```
conf/<chip>/<board>/lib.config //编译发布 loader 的库功能配置文件。
```

- 如果想要gdb调试lib，需要将.config中的ENABLE\_GDB\_DEBUG打开为y。
