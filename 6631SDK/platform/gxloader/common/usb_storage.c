 ...
 * when reading a 16M or more larger file, some USB flash disk products will
 * result in internal error, return CSW packet with bCSWStatus = 2 (phase error)
 * without a STALL handshake and any data packet,so adjust this macro from 65535 to 1024
 */
#define USB_MAX_XFER_BLK	64
#else
