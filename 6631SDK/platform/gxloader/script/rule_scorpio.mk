...
ifeq ($(CHIP_BOARD), 3113XX)
DDR_SEC_PAR_INCLUDE =  "ddr3_qfn_667MHz_128MB.h"
endif
...
ifeq ($(ENABLE_SECURE_VERIFY), y)
	...
	@cd $(SIGN_DIR);./digital_signature.sh 1 $(NORMAL_FILE_NAME) $(SECURE_VERIFY_TYPE) scorpio 1 $(ENABLE_EXTERN_PARAM) $(EXTERN_PARAM_FILE_SIZE);cd $(CUR_PWD)
	@mv $(SIGN_DIR)/output/$(SIGN_LEVEL1_FILE_NAME) $(SIGN_LEVEL1_FILE_NAME)
	@cd $(SIGN_DIR);./digital_signature.sh 1 $(NORMAL_FILE_NAME) $(SECURE_VERIFY_TYPE) scorpio 2 $(ENABLE_EXTERN_PARAM) $(EXTERN_PARAM_FILE_SIZE);cd $(CUR_PWD)
...
LD_FILE=cpu/ck/scorpio/$(LD_FILE_NAME)
