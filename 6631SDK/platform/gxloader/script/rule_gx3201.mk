...
ifeq ($(ENABLE_GDI), y)
COBJS-y += drivers/vout/gx3201_vout.o
...
##############################################################
	...
	@echo "#define CONFIG_ARCH_CKMMU_GX3201" >> $@
	@echo "#define CHIP_CORE                   \"$(CHIP_CORE)\"" >> $@
	@echo "#define CONFIG_REV                   \"$(CHIP_CORE_REV)\"" >> $@
	@echo "#define CONFIG_ARCH_CKMMU_GX3201_REV   $(CHIP_CORE_REV)" >> $@
...
ifeq ($(DVB_CHANNEL_C), y)
	...
	@echo "#define DEFAULT_EXT_CLOCK_XTAL      27000000" >> $@
