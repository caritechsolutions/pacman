...
{
	if(boundary <= 4096)
		return page_malloc(size);	// 4k align
	else
		return NULL;
}
#ifndef roundup
...
void print_ehci_regs(void)
{
	...
	printf ("    hcsparam  : %08x\n", hccr->cr_hcsparams);
	printf ("    hccparam  : %08x\n", hccr->cr_hccparams);
	printf ("    hcsp_port : %08x %08x\n", *((unsigned int *)&hccr->cr_hcsp_portrt[0]), *((unsigned int *)&hccr->cr_hcsp_portrt[4]));
	...
	printf ("    usbintr          : %08x\n", hcor->or_usbintr);
	printf ("    frindex          : %08x\n", hcor->or_frindex);
	printf ("    ctrldssegment    : %08x\n", hcor->or_ctrldssegment);
	printf ("    periodiclistbase : %08x\n", hcor->or_periodiclistbase);
	printf ("    asynclistaddr    : %08x\n", hcor->or_asynclistaddr);
	printf ("    _reserved_0_     : %08x\n", hcor->_reserved_0_);
	printf ("    burstsize        : %08x\n", hcor->or_burstsize);
	printf ("    txfilltuning     : %08x\n", hcor->or_txfilltuning);
	printf ("    reserve0         : %08x\n", hcor->_reserved_1_[0]);
	printf ("    reserve1         : %08x\n", hcor->_reserved_1_[1]);
	printf ("    reserve2         : %08x\n", hcor->_reserved_1_[2]);
	printf ("    reserve3         : %08x\n", hcor->_reserved_1_[3]);
		 ...
		 int elementsize, void *buffer)
{
	...
	for (i = 0; i < queuesize; i++) {
		...
		*buf = (void *)((u32)buffer + i * elementsize);
	}
