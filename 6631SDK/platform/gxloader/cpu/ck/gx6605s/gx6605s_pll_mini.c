...
static struct param{
	...
	{432000000  , 0  , 1  , 1  , 36} ,  // 432Hz
	{533000000  , 0  , 0  , 4 ,  89} , // 533MHz
	{594000000  , 0  , 0  , 4  , 99 } , // 816MHz
	{999000000  , 0  , 0  , 5  , 208 } , // 999MHz
	{1188000000 , 0  , 0  , 2  , 99 } , // 1.188GHz
#else
	{378000000  , 0  , 1  , 5  , 139} ,  // 375.3MHz
	{391000000  , 0  , 1  , 2  , 58} ,  // 391MHz
	{400000000  , 0  , 1  , 5  , 148} ,  // 399.6MHz
	{432000000  , 0  , 1  , 1  , 32} ,  // 432Hz
	{533000000  , 0  , 0  , 10 , 198} , // 533MHz
...
/**************	// DTO CPU clock****************/
#if 1   //CPU_FREQ
	DTO_Config(12, 0x20000000, 0); //594M
	serial_put_no_mmu('R');
	//set CPU AXI bus
...
///	end DDR clock
	...
	*(volatile unsigned int*)(CONFIG_BASE+CONFIG_CPU_32BIT_ANLIGN) |= 3; //config cpu 32 bit align
#endif
