...
struct mulpin_config_s mulpin_table[] = {
	...
	{136,       5,      37,     MP_INV_V,  1},           // 39          | TSI1DATA0_PORT5_NFWE_BTDATA0
#ifdef GX1133_SUPPORT
...
#else
	{137,       6,      38,          136,  2},           // 40          | TSI1DATA1_PORT6_SC1CLK_BTDATA1_SCTDI
	{138,       7,      39,          136,  2},           // 41          | TSI1DATA2_PORT7_SC1RST_BTDATA2_SCTDO
	{139,       8,      40,          136,  2},           // 42          | TSI1DATA3_PORT8_SC1PWR_BTDATA3_SCTMS
	{140,       9,      41,          136,  2},           // 43          | TSI1DATA4_PORT9_SC1CD_BTDATA4_SCTCK
	{141,       10,     42,          136,  2},           // 44          | TSI1DATA5_PORT10_SC1DATA_BTDATA5_SCTRST
#endif
	...
	{163,       16,     48,          137,  1},           // 50          | UARTTXICAM_UART2TX_NFDAT3_PCMSCKO_SCUARTTX
	{164,       17,     49,          137,  1},           // 51          | UARTRXICAM_UART2RX_NFDAT2_PCMLRCK_SCUARTRX
	...
	{277,       30,     62,     MP_INV_V,  1},           // 94          | MD_PORT30_LINKLED
	{278,       31,     63,     MP_INV_V,  1},           // 95          | MDC_PORT31_ACTLED
	{279,       64,     96,     MP_INV_V,  0},           // NC          | RMTXEN_PORT32_AJTDI_SC1CLK
	{281,       65,     97,     MP_INV_V,  0},           // NC          | RMTXD1_PORT33_AJTDO_SC1RST
	{282,       66,     98,     MP_INV_V,  0},           // NC          | RMTXD0_PORT34_AJTMS_SC1PWR
	{283,       67,     99,     MP_INV_V,  0},           // NC          | RMCLK_PORT35_AJTCK_SC1CD
	{285,       68,     100,    MP_INV_V,  0},           // NC          | RMRXD1_PORT36_AJRST_SC1DATA
	{287,       69,     101,    MP_INV_V,  0},           // NC          | RMRXD0_PORT37_AOAMCLK
...
struct gpio_entry_bootloader g_gpio_table[] = {
	...
	{4,  5, GX_GPIO_CONFIG_VALID, GX_GPIO_OUTPUT, GX_GPIO_HIGH },    //T2 LNB
	{5,  31, GX_GPIO_CONFIG_VALID, GX_GPIO_OUTPUT, GX_GPIO_HIGH },   //T1 LNB
	{10,  0, GX_GPIO_CONFIG_VALID, GX_GPIO_OUTPUT, GX_GPIO_LOW },   //T2 RESET
    {20, 30, GX_GPIO_CONFIG_VALID, GX_GPIO_INPUT,  GX_GPIO_HIGH},//shortcut detect, 0:shortcut, 1:normal
    {21, 1, GX_GPIO_CONFIG_VALID, GX_GPIO_INPUT,  GX_GPIO_HIGH},//shortcut detect, 0:shortcut, 1:normal
...
#else
	ts_mode_config(1, 1, 3, 0, 1, 1, 0);	//set ts1 to serial ts, and mode is 3, no valid, sync,big endian,eadge
#endif

	//tuner2 reset
	udelay(100*1000);
	gx_gpio_setlevel(10, GX_GPIO_HIGH);
	// UART2TX used to mute control. init to mute
