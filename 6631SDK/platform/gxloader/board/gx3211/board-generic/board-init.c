...
struct mulpin_config_s mulpin_table[] = {
 ...
 /* chip_core_num | 0_bit | 1_bit |  2_bit  |func_sel*/ /* package_num | func_list */
        ...
        {104,       0,      32,     MP_INV_V,  0},           // NC          | DBGTDI_PORT0
        {105,       1,      33,     MP_INV_V,  0},           // NC          | DBGTDO_PORT1
        {106,       2,      34,     MP_INV_V,  0},           // NC          | DBGTMS_PORT2
        {107,       3,      35,     MP_INV_V,  0},           // NC          | DBGTCK_PORT3
        {108,       4,      36,     MP_INV_V,  0},           // NC          | DBGTRST_PORT4
#endif
        ...
        {161,       14,     46,     MP_INV_V,  0},           // NC          | SDA2_PORT14_AUARTTX_PCMBCK
        {162,       15,     47,     MP_INV_V,  0},           // NC          | SCL2_PORT15_NFDAT4_PCMDIN
        ...
        {165,       18,     50,     MP_INV_V,  0},           // NC          | HVSEL_PORT18_NFDAT1_DiSEqCi
        {166,       19,     51,     MP_INV_V,  0},           // NC          | DiSEqCo_PORT19_NFDAT0
        {168,       20,     52,     MP_INV_V,  0},           // NC          | AGC_PORT20
        {175,       21,     53,     MP_INV_V,  0},           // NC          | UART1TX_PORT21_AUARTTX
        {176,       22,     54,     MP_INV_V,  0},           // NC          | UART1RX_PORT22
        {177,       23,     55,     MP_INV_V,  0},           // NC          | SDA1_PORT23
        {178,       24,     56,     MP_INV_V,  0},           // NC          | SCL1_PORT24
        {272,       26,     58,     MP_INV_V,  0},           // NC          | DDCSDA_PORT26_SDA2_HDMIDTB0
        {273,       27,     59,     MP_INV_V,  0},           // NC          | DDCSCL_PORT27_SCL2_HDMIDTB1
        {274,       28,     60,     MP_INV_V,  0},           // NC          | SPDIF_PORT28
        {276,       29,     61,     MP_INV_V,  0},           // NC          | RMCRSDV_PORT29_SPDLED
        {277,       30,     62,     MP_INV_V,  2},           // NC          | MD_PORT30_LINKLED
        {278,       31,     63,     MP_INV_V,  2},           // NC          | MDC_PORT31_ACTLED
