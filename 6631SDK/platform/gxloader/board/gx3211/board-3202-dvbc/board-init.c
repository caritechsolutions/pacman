...
struct mulpin_config_s mulpin_table[] = {
 ...
 /* chip_core_num | 0_bit | 1_bit |  2_bit  |func_sel*/ /* package_num | func_list */
        ...
        {162,       15,     47,     MP_INV_V,  0},            // 48       | SCL2_PORT15_NFDAT4_PCMDIN
        {163,       16,     48,          137,  0},            // 49       | UARTTXICAM_UART2TX_NFDAT3_PCMSCKO_SCUARTTX
        {164,       17,     49,          137,  0},            // 50       | UARTRXICAM_UART2RX_NFDAT2_PCMLRCK_SCUARTRX
        {165,       18,     50,     MP_INV_V,  0},            // 51       | HVSEL_PORT18_NFDAT1_DiSEqCi
        {166,       19,     51,     MP_INV_V,  0},            // 52       | DiSEqCo_PORT19_NFDAT0
        {168,       20,     52,     MP_INV_V,  0},            // 53       | AGC_PORT20
        {175,       21,     53,     MP_INV_V,  0},            // 57       | UART1TX_PORT21_AUARTTX
        {176,       22,     54,     MP_INV_V,  0},            // 58       | UART1RX_PORT22
        {177,       23,     55,     MP_INV_V,  0},            // 59       | SDA1_PORT23
        {178,       24,     56,     MP_INV_V,  0},            // 60       | SCL1_PORT24
