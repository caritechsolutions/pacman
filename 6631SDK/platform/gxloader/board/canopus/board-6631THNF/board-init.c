...
/*       pin_id  func_sel                          fun0               fun1         fun2         fun3         fun4       fun5         fun6         fun7         */
        ...
        {12,       1},          //NC          |GPIO12(PMUPORT12) |DBGTDI       |SDBGTDI      |            |           |            |            |                |
        {13,       1},          //NC          |GPIO13(PMUPORT13) |DBGTDO       |SDBGTDO      |            |           |            |            |                |
        {14,       1},          //NC          |GPIO14(PMUPORT14) |DBGTMS       |SDBGTMS      |            |           |            |            |                |
        ...
        {43,       5},          //NC          |GPIO43            |TSODATA[5]   |TSI3DATA[5]  |NFDATA[0]   |TSIS2CLK   |SC1PWR      |            |HDMI_CH0_B[8]   |
        {44,       5},          //NC          |GPIO44            |TSODATA[4]   |TSI3DATA[4]  |            |TSIS2SYNC  |SC1CD       |            |HDMI_CH0_B[7]   |
        {45,       5},          //NC          |GPIO45            |TSODATA[3]   |TSI3DATA[3]  |HVSEL       |SDA3       |SC1DATA     |SDA3        |HDMI_CH0_B[6]   |
        {46,       0},          //NC          |GPIO46            |TSODATA[2]   |TSI3DATA[2]  |DiSEqCi     |SCL3       |            |SCL3        |HDMI_CH0_B[5]   |
        {47,       0},          //NC          |GPIO47            |TSODATA[1]   |TSI3DATA[1]  |DiSEqCo     |AGC2       |UART3TX     |            |                |
        {48,       0},          //NC          |GPIO48            |TSODATA[0]   |TSI3DATA[0]  |AGC         |           |UART3RX     |            |HDMI_CH0_B[4]   |
        {49,       0},          //NC          |GPIO49            |TSOCLK       |TSI3CLK      |SDA1        |SDA_T      |UART3CTS    |            |HDMI_CH0_B[3]   |
        {50,       0},          //NC          |GPIO50            |TSOSYNC      |TSI3SYNC     |SCL1        |SCL_T      |UART3RTS    |            |HDMI_CH0_B[2]   |
...
struct gpio_entry_bootloader g_gpio_table[] = {
	{16, 0, GX_GPIO_CONFIG_VALID, GX_GPIO_OUTPUT, GX_GPIO_HIGH}, //Power control: 0-standby mode; 1-normal mode
	...
	{7, 3, GX_GPIO_CONFIG_VALID, GX_GPIO_OUTPUT, GX_GPIO_LOW}, //PHY reset: 0-reset; 1-normal
	{15, 6, GX_GPIO_CONFIG_VALID, GX_GPIO_INPUT, GX_GPIO_LOW}, //1:short  0:normal
	{10, 49, GX_GPIO_CONFIG_VALID, GX_GPIO_OUTPUT, GX_GPIO_LOW}, //Demod reset: 0-reset; 1-normal
	{ 0, 7, GX_GPIO_CONFIG_VALID, GX_GPIO_INPUT,   GX_GPIO_LOW}, //Panel data
	{ 1, 8, GX_GPIO_CONFIG_VALID, GX_GPIO_OUTPUT, GX_GPIO_HIGH}, //Panel clock
	{3, 5, GX_GPIO_CONFIG_VALID, GX_GPIO_OUTPUT, GX_GPIO_LOW}, //L/R Audio output mute control: 0-mute; 1-unmute
...
extern int usb_recover_proc(void);
	...
	ts_mode_config(1, 0, 0, 0, 0, 0, 0);//set ts1 to parallel ts
	*(volatile unsigned int*)(0x89400680) |= (0x1<<24);
	return 0;
}
