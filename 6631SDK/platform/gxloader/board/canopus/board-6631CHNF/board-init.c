...
/*       pin_id  func_sel                          fun0               fun1         fun2         fun3         fun4       fun5         fun6         fun7         */
        {0,        1},          //NC          |GPIO00(PMUPORT00) |MD           |SDIO_CLK     |            |           |            |            |HDMI_CH2_R[2]   |
        {1,        1},          //NC          |GPIO01(PMUPORT01) |MDC          |SDIO_CMD     |ADCQDATA[6] |           |            |            |HDMI_CH2_R[1]   |
        {2,        1},          //NC          |GPIO02(PMUPORT02) |RMCRSDV      |SDIO_DATA[0] |ADCQDATA[5] |           |            |            |HDMI_CH2_R[0]   |
        {3,        1},          //NC          |GPIO03(PMUPORT03) |RMTXEN       |SDIO_DATA[1] |ADCQDATA[4] |           |            |            |HDMI_CH1_G[9]   |
        {4,        1},          //NC          |GPIO04(PMUPORT04) |RMTXD[1]     |SDIO_DATA[2] |ADCQDATA[3] |           |            |            |HDMI_CH1_G[8]   |
        {5,        1},          //NC          |GPIO05(PMUPORT05) |RMTXD[0]     |SDIO_DATA[3] |ADCQDATA[2] |           |            |            |HDMI_CH1_G[7]   |
        {6,        1},          //NC          |GPIO06(PMUPORT06) |RMCLK        |SDIO_PWR     |ADCQDATA[1] |           |            |            |HDMI_CH1_G[6]   |
        {7,        1},          //NC          |GPIO07(PMUPORT07) |RMRXD[1]     |SDIO_CD      |ADCQDATA[0] |UART1_CTS  |MD          |            |                |
        {8,        1},          //NC          |GPIO08(PMUPORT08) |RMRXD[0]     |SDIO_WP      |ADCCLKOUT   |UART1_RTS  |MDC         |            |                |
        ...
        {18,       0},          //NC          |GPIO18            |TSI1DATA[6]  |TSIS1DATA[0] |NFOE        |SPISCK     |NF_SPISCK   |UART2TX     |ADCIDATA[8]     |
        {19,       0},          //NC          |GPIO19            |TSI1DATA[5]  |TSIS1CLK     |NFCLE       |SPIMOSI    |NF_SPIMOSI  |UART2RX     |ADCIDATA[7]     |
        {20,       0},          //NC          |GPIO20            |TSI1DATA[4]  |TSIS1SYNC    |NFALE       |SPICSN     |NF_SPICSN   |SDA2        |ADCIDATA[6]     |
        {21,       0},          //NC          |GPIO21            |TSI1DATA[3]  |TSIS1VALID   |NFWE        |SPIMISO    |NF_SPIMISO  |SCL2        |ADCIDATA[5]     |
        {22,       0},          //NC          |GPIO22            |TSI1DATA[2]  |SC1CLK       |NFDATA[7]   |SPIWP      |NF_SPIWP    |DBGTDI      |ADCIDATA[4]     |
        ...
        {45,       0},          //NC          |GPIO45            |TSODATA[3]   |TSI3DATA[3]  |HVSEL       |SDA3       |SC1DATA     |SDA3        |HDMI_CH0_B[6]   |
