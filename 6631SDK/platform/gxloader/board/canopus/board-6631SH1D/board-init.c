...
struct gpio_entry_bootloader g_gpio_table[] = {
	...
	{3,  78, GX_GPIO_CONFIG_VALID, GX_GPIO_OUTPUT, GX_GPIO_HIGH},//mute control for cvbs, 1:mute; 0:unmute
	{5,  81, GX_GPIO_CONFIG_VALID, GX_GPIO_OUTPUT, GX_GPIO_LOW},//LNB power, 0:enable, 1:disable
	{20, 21, GX_GPIO_CONFIG_VALID, GX_GPIO_INPUT,  GX_GPIO_LOW},//shortcut detect, 1:shortcut, 0:normal
