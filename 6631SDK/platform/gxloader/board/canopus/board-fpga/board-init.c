...
/*       pin_id  func_sel                          fun0               fun1         fun2         fun3         fun4       fun5         fun6         fun7         */
        ...
        {16,       1},          //NC          |GPIO16(PMUPORT16) |DBGTRST      |SDBGTRST     |CEC         |           |            |            |                |
#endif
        ...
        {47,       5},          //NC          |GPIO47            |TSODATA[1]   |TSI3DATA[1]  |DiSEqCo     |AGC2       |UART3TX     |            |                |
        {48,       5},          //NC          |GPIO48            |TSODATA[0]   |TSI3DATA[0]  |AGC         |           |UART3RX     |            |HDMI_CH0_B[4]   |
        {49,       5},          //NC          |GPIO49            |TSOCLK       |TSI3CLK      |SDA1        |SDA_T      |UART3CTS    |            |HDMI_CH0_B[3]   |
        {50,       5},          //NC          |GPIO50            |TSOSYNC      |TSI3SYNC     |SCL1        |SCL_T      |UART3RTS    |            |HDMI_CH0_B[2]   |
        ...
        {67,       2},          //NC          |GPIO67            |SDIO_DATA[1] |UART2_CTS    |            |           |            |            |PHY_HDMI_PCLK   |
        {68,       2},          //NC          |GPIO68            |SDIO_DATA[2] |UART2_RTS    |            |           |            |            |                |
        ...
        {86,       0},          //NC          |GPIO86            |RMRXD[0]     |             |            |           |            |            |                |
        {87,       0},          //NC          |GPIO87            |MD           |PHY_CLK      |            |           |            |            |                |
        {90,       0},          //NC          |GPIO90            |MDC          |             |            |           |            |            |                |
        {91,       0},          //NC          |GPIO91            |NFRDY        |SPIHOLD      |NF_SPIHOLD  |PHY_CLK    |            |            |                |
        {92,       0},          //NC          |GPIO92            |NFOE         |SPISCK       |NF_SPISCK   |           |            |            |                |
        {93,       0},          //NC          |GPIO93            |NFCLE        |SPIMOSI      |NF_SPIMOSI  |           |            |            |                |
        {94,       0},          //NC          |GPIO94            |NFALE        |SPICSN       |NF_SPICSN   |           |            |            |                |
        {95,       0},          //NC          |GPIO95            |NFWE         |SPIMISO      |NF_SPIMISO  |           |            |            |                |
...
extern int usb_recover_proc(void);
	...
	ts_mode_config(1, 1, 3, 0, 1, 1, 1);    //set ts1 to serial ts, and mode is 3, no valid, sync,big endian,eadge //demux 边沿取反防止msk
