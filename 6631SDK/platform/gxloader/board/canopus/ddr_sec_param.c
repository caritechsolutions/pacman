...
unsigned int DENALI_CONFIG_CTL_2[159] __attribute__((section(".sram"))) = {
	DENALI_CTL_00_DATA,
	DENALI_CTL_01_DATA,
	DENALI_CTL_02_DATA,
	DENALI_CTL_03_DATA,
...
unsigned int DENALI_CONFIG_PHY_2[31]  __attribute__((section(".sram"))) = {
