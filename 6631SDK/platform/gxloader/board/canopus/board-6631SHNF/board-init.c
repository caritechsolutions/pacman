...
/*       pin_id  func_sel                          fun0               fun1         fun2         fun3         fun4       fun5         fun6         fun7         */
...
#if 1//ndef CONFIG_DBG_PIN_NO_MULTI
        {12,       0},          //NC          |GPIO12(PMUPORT12) |DBGTDI       |SDBGTDI      |            |           |            |            |                |
        {13,       0},          //NC          |GPIO13(PMUPORT13) |DBGTDO       |SDBGTDO      |            |           |            |            |                |
        {14,       0},          //NC          |GPIO14(PMUPORT14) |DBGTMS       |SDBGTMS      |            |           |            |            |                |
        {15,       1},          //NC          |GPIO15(PMUPORT15) |DBGTCK       |SDBGTCK      |            |           |            |            |                |
        {16,       3},          //NC          |GPIO16(PMUPORT16) |DBGTRST      |SDBGTRST     |CEC         |           |            |            |                |
#endif
        {17,       1},          //NC          |GPIO17(PMUPORT17) |TSI1DATA[7]  |TSIS1DATA[1] |NFRDY       |SPIHOLD    |NF_SPIHOLD  |ADCIDATA[9] |                |
        {18,       1},          //NC          |GPIO18            |TSI1DATA[6]  |TSIS1DATA[0] |NFOE        |SPISCK     |NF_SPISCK   |UART2TX     |ADCIDATA[8]     |
        {19,       1},          //NC          |GPIO19            |TSI1DATA[5]  |TSIS1CLK     |NFCLE       |SPIMOSI    |NF_SPIMOSI  |UART2RX     |ADCIDATA[7]     |
        {20,       1},          //NC          |GPIO20            |TSI1DATA[4]  |TSIS1SYNC    |NFALE       |SPICSN     |NF_SPICSN   |SDA2        |ADCIDATA[6]     |
        {21,       1},          //NC          |GPIO21            |TSI1DATA[3]  |TSIS1VALID   |NFWE        |SPIMISO    |NF_SPIMISO  |SCL2        |ADCIDATA[5]     |
        {22,       1},          //NC          |GPIO22            |TSI1DATA[2]  |SC1CLK       |NFDATA[7]   |SPIWP      |NF_SPIWP    |DBGTDI      |ADCIDATA[4]     |
        {23,       1},          //NC          |GPIO23            |TSI1DATA[1]  |SC1RST       |NFDATA[6]   |DBGTDO     |ADCIDATA[3] |            |HDMI_CH1_G[5]   |
        {24,       1},          //NC          |GPIO24            |TSI1DATA[0]  |SC1PWR       |NFDATA[5]   |DBGTMS     |ADCIDATA[2] |            |HDMI_CH1_G[4]   |
        {25,       1},          //NC          |GPIO25            |TSI1CLK      |SC1CD        |NFDATA[4]   |DBGTCK     |ADCIDATA[1] |            |HDMI_CH1_G[3]   |
        {26,       1},          //NC          |GPIO26            |TSI1SYNC     |SC1DATA      |NFDATA[3]   |DBGTRST    |ADCIDATA[0] |            |HDMI_CH1_G[2]   |
        {27,       1},          //NC          |GPIO27            |TSI1VALID    |             |NFDATA[2]   |           |            |            |                |
        {28,       0},          //NC          |GPIO28            |             |             |NFDATA[1]   |           |            |            |                |
        {29,       0},          //NC          |GPIO29            |             |             |NFDATA[0]   |           |            |            |                |
        {30,       1},          //NC          |GPIO30            |TSOVALID     |TSI3VALID    |TSI2VALID   |           |            |            |HDMI_CH1_G[1]   |
        {31,       1},          //NC          |GPIO31            |TSODATA[7]   |TSIS3DATA[1] |TSI2DATA[7] |           |            |            |                |
        {32,       1},          //NC          |GPIO32            |TSODATA[6]   |TSIS3DATA[0] |TSI2DATA[6] |           |            |            |                |
        {33,       1},          //NC          |GPIO33            |TSODATA[5]   |TSIS3CLK     |TSI2DATA[5] |           |            |            |                |
        {34,       0},          //NC          |GPIO34            |TSODATA[4]   |TSIS3SYNC    |TSI2DATA[4] |           |            |            |                |
        {35,       1},          //NC          |GPIO35            |TSODATA[3]   |TSIS3VALID   |TSI2DATA[3] |           |            |            |                |
        {36,       1},          //NC          |GPIO36            |TSODATA[2]   |SC1CLK       |TSI2DATA[2] |           |            |            |                |
        {37,       1},          //NC          |GPIO37            |TSODATA[1]   |SC1RST       |TSI2DATA[1] |           |            |            |                |
        {38,       1},          //NC          |GPIO38            |TSODATA[0]   |SC1PWR       |TSI2DATA[0] |           |            |            |                |
        {39,       1},          //NC          |GPIO39            |TSOCLK       |SC1CD        |TSI2CLK     |           |            |            |                |
        {40,       1},          //NC          |GPIO40            |TSOSYNC      |SC1DATA      |TSI2SYNC    |           |            |            |                |
        ...
        {55,       1},          //NC          |GPIO55            |SDA2         |SDA_T        |            |           |            |            |PHY_HDMI_LOCKED |
        {56,       1},          //NC          |GPIO56            |SCL2         |SCL_T        |            |           |            |            |PHY_HDMI_RXDET  |
        {57,       0},          //NC          |GPIO57            |             |             |            |           |            |            |                |
        {58,       0},          //NC          |GPIO58            |             |             |            |           |            |            |                |
        {59,       0},          //NC          |GPIO59            |             |             |            |           |            |            |                |
        {60,       0},          //NC          |GPIO60            |             |             |            |           |            |            |                |
        ...
        {90,       1},          //NC          |GPIO90            |MDC          |             |            |           |            |            |                |
        {91,       2},          //NC          |GPIO91            |NFRDY        |SPIHOLD      |NF_SPIHOLD  |PHY_CLK    |            |            |                |
        ...
        {96,       2},          //NC          |GPIO96            |NFDATA[7]    |SPIWP        |NF_SPIWP    |           |            |            |                |
...
struct gpio_entry_bootloader g_gpio_table[] = {
	...
	{27, 0, GX_GPIO_CONFIG_VALID, GX_GPIO_OUTPUT, GX_GPIO_HIGH}, //Power control: 0-standby mode; 1-normal mode
	{30, 1, GX_GPIO_CONFIG_VALID, GX_GPIO_OUTPUT, GX_GPIO_HIGH}, //IR RCU indicate: 0-no date; 1-reveive data
    {11, 2, GX_GPIO_CONFIG_VALID, GX_GPIO_OUTPUT, GX_GPIO_HIGH}, //LED for power and standby, 1: power led display, 0:standby led display
	{31, 3, GX_GPIO_CONFIG_VALID, GX_GPIO_INPUT,  GX_GPIO_LOW}, //LNB shortcut, 1: shortcut, 0:normal
	{ 5, 4, GX_GPIO_CONFIG_VALID, GX_GPIO_OUTPUT, GX_GPIO_HIGH}, //LNB Power: 0-on; 1-off
	{15, 12, GX_GPIO_CONFIG_VALID, GX_GPIO_OUTPUT, GX_GPIO_HIGH}, //T2 ANT
	{90, 5, GX_GPIO_CONFIG_VALID, GX_GPIO_OUTPUT, GX_GPIO_HIGH}, //SCI VCC control: 0-3V; 1-5V
	{ 0, 13, GX_GPIO_CONFIG_VALID, GX_GPIO_INPUT,  GX_GPIO_LOW}, //Panel data
	{ 1, 14, GX_GPIO_CONFIG_VALID, GX_GPIO_OUTPUT, GX_GPIO_HIGH}, //Panel clock
	{ 3, 76, GX_GPIO_CONFIG_VALID, GX_GPIO_OUTPUT, GX_GPIO_HIGH}, //L/R Audio output mute control: 0-unmute; 1-mute
	{10, 34, GX_GPIO_CONFIG_VALID, GX_GPIO_OUTPUT, GX_GPIO_LOW}, //Demod reset, 0: reset, 1: normal
	{7, 58, GX_GPIO_CONFIG_VALID, GX_GPIO_OUTPUT, GX_GPIO_LOW}, //PHY reset: 0-reset; 1-normal
...
#endif
    udelay(100*1000);
    gx_gpio_setlevel(10, GX_GPIO_HIGH);

    /* #406059 配置2bit需要打补丁 */
    /*
     * 等同于
     * ts_mode_config(1, 1, 0x688, 0, 1, 1, 1);
     * *(volatile unsigned int *)0x8a2036e8 = 0x4;
    */
    ts_mode_config(1, 2, 0x688, 0, 1, 1, 1);

    *(volatile unsigned int *)0x89400680 |= (1<<24);
