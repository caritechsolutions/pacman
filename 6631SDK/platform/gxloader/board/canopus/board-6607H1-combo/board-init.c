...
struct gpio_entry_bootloader g_gpio_table[] = {
	{15, 12, GX_GPIO_CONFIG_VALID, GX_GPIO_OUTPUT, GX_GPIO_HIGH},//ANT_POWER/SHORT 1:ANT_POWER ON 0:ANT_POWER OFF
	...
	{20, 21, GX_GPIO_CONFIG_VALID, GX_GPIO_INPUT, GX_GPIO_LOW},// LNB1 short, 0: normal, 1: short
	{7,  91, GX_GPIO_CONFIG_VALID, GX_GPIO_OUTPUT, GX_GPIO_LOW}, //PHY reset, 0: reset,  1: normal
	{10, 96, GX_GPIO_CONFIG_VALID, GX_GPIO_OUTPUT, GX_GPIO_LOW}, //Demod reset, 0: reset, 1: normal
