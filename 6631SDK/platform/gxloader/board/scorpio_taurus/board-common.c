...
extern struct gpio_entry_bootloader g_scorpio_gpio_table[];
extern struct gpio_entry_bootloader g_taurus_gpio_table[];
...
void gpio_init(void)
{
	...
	if (gxcore_chip_probe() == 0x3113)
		g_gpio_table = g_scorpio_gpio_table;
	else
		g_gpio_table = g_taurus_gpio_table;
