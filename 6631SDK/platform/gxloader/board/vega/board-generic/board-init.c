...
/*       pin_id  func_sel                            fun0               fun1         fun2           fun3         fun4         fun5         fun6         fun7         */
        ...
        {7,         4},          //NC          |GPIO07 (PMUPORT07) |RMRXD[1]     |SDIO_DATA[3] |UART1_CTS    |MD          |            |              |           |
        {8,         5},          //NC          |GPIO08 (PMUPORT08) |RMRXD[0]     |SDIO_DATA[2] |ADCQDATA[9]  |UART1_RTS   |MDC         |CEC(开漏输出) |           |
        ...
        {91,        2},          //NC          |GPIO91             |NFRDY        |RMCRSDV      |PHY_CLK      |            |            |              |           |
