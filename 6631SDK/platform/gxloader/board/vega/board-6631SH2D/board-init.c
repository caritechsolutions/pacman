...
/*       pin_id  func_sel                            fun0               fun1         fun2           fun3         fun4         fun5         fun6         fun7         */
        ...
        {47,        3},          //NC          |GPIO47             |TSODATA[1]   |TSI2DATA[1]  |DiSEqCo      |AGC2        |UART3TX     |ADCIDATA[3]   |HDMI_TX    |
...
struct gpio_entry_bootloader g_gpio_table[] = {
	...
	{3,  91, GX_GPIO_CONFIG_VALID, GX_GPIO_OUTPUT, GX_GPIO_LOW},//mute control for cvbs, 0:mute; 1:unmute
	{5,  92, GX_GPIO_CONFIG_VALID, GX_GPIO_OUTPUT, GX_GPIO_HIGH},//LNB power, 1:enable, 0:disable
