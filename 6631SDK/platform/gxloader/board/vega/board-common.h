...
#define TS_MUX_DVB_TS_OUT      0
#define TS_MUX_TS_S_0          1
#define TS_MUX_TS_P_1          2
#define TS_MUX_TS_P_2          3
#define TS_MUX_DVB_TS_OUT1     4
#define TS_MUX_TSIO0           5
#define TS_MUX_TSIO1           6

#define TS_IN_TS0_P            0
#define TS_IN_TS0_S            1
#define TS_IN_TS1_P_S          2
#define TS_IN_TS2_P_S          3
#define TS_IN_TS3_P_S          4
