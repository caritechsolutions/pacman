...
/*       pin_id  func_sel                            fun0               fun1         fun2           fun3         fun4         fun5         fun6         fun7         */
        ...
        {2,         2},          //NC          |GPIO02 (PMUPORT02) |RMCRSDV      |SDIO_CD      |             |            |            |              |           |
        {3,         2},          //NC          |GPIO03 (PMUPORT03) |RMTXEN       |SDIO_DATA[1] |             |            |            |              |           |
        {4,         2},          //NC          |GPIO04 (PMUPORT04) |RMTXD[1]     |SDIO_DATA[0] |             |            |            |              |           |
        {5,         2},          //NC          |GPIO05 (PMUPORT05) |RMTXD[0]     |SDIO_CLK     |PLL_OUT1     |            |            |              |           |
        {6,         2},          //NC          |GPIO06 (PMUPORT06) |RMCLK        |SDIO_CMD     |             |            |            |              |           |
        {7,         2},          //NC          |GPIO07 (PMUPORT07) |RMRXD[1]     |SDIO_DATA[3] |UART1_CTS    |MD          |            |              |           |
        {8,         2},          //NC          |GPIO08 (PMUPORT08) |RMRXD[0]     |SDIO_DATA[2] |ADCQDATA[9]  |UART1_RTS   |MDC         |CEC(开漏输出) |           |
        ...
        {16,        1},          //NC          |GPIO16 (PMUPORT16) |DBGTRST      |CEC          |             |            |            |              |           |
#endif
        {17,        0},          //NC          |GPIO17 (PMUPORT17) |TSI1DATA[7]  |TSODATA[7]   |TSIS0DATA[1] |CEC         |            |              |           |
        {18,        7},          //NC          |GPIO18             |TSI1DATA[6]  |TSODATA[6]   |TSIS0DATA[0] |ADCQDATA[9] |UART2TX     |DBGTDI        |SC1CLK     |
        {19,        7},          //NC          |GPIO19             |TSI1DATA[5]  |TSODATA[5]   |TSIS0CLK     |ADCQDATA[8] |UART2RX     |DBGTDO        |SC1RST     |
        {20,        7},          //NC          |GPIO20             |TSI1DATA[4]  |TSODATA[4]   |TSIS0SYNC    |ADCQDATA[7] |SDA2        |DBGTMS        |SC1DATA    |
        {21,        7},          //NC          |GPIO21             |TSI1DATA[3]  |TSODATA[3]   |TSIS0VALID   |ADCQDATA[6] |SCL2        |DBGTCK        |SC1PWR     |
        {22,        7},          //NC          |GPIO22             |TSI1DATA[2]  |TSODATA[2]   |SC1CLK       |ADCQDATA[5] |            |DBGTRST       |SC1CD      |
        {23,        0},          //NC          |GPIO23             |TSI1DATA[1]  |TSODATA[1]   |SC1RST       |ADCQDATA[4] |            |              |           |
        {24,        0},          //NC          |GPIO24             |TSI1DATA[0]  |TSODATA[0]   |SC1PWR       |ADCQDATA[3] |            |              |           |
        {25,        0},          //NC          |GPIO25             |TSI1CLK      |TSOCLK       |SC1CD        |ADCQDATA[2] |            |              |           |
        {26,        0},          //NC          |GPIO26             |TSI1SYNC     |TSOSYNC      |SC1DATA      |ADCQDATA[1] |            |              |           |
        ...
        {45,        0},          //NC          |GPIO45             |TSODATA[3]   |TSI2DATA[3]  |HVSEL        |SDA3        |SC1DATA     |ADCIDATA[5]   |           |
        {46,        0},          //NC          |GPIO46             |TSODATA[2]   |TSI2DATA[2]  |DiSEqCi      |SCL3        |HVSEL       |ADCIDATA[4]   |           |
        {47,        0},          //NC          |GPIO47             |TSODATA[1]   |TSI2DATA[1]  |DiSEqCo      |AGC2        |UART3TX     |ADCIDATA[3]   |HDMI_TX    |
        {48,        0},          //NC          |GPIO48             |TSODATA[0]   |TSI2DATA[0]  |AGC          |            |UART3RX     |ADCIDATA[2]   |HDMI_RX    |
        {49,        0},          //NC          |GPIO49             |TSOCLK       |TSI2CLK      |SDA1         |SDA_T       |UART3CTS    |ADCIDATA[1]   |           |
        {50,        0},          //NC          |GPIO50             |TSOSYNC      |TSI2SYNC     |SCL1         |SCL_T       |UART3RTS    |ADCIDATA[0]   |           |
        {51,        1},          //NC          |GPIO51             |HVSEL        |SDA4         |             |            |            |              |           |
        {52,        1},          //NC          |GPIO52             |DiSEqCi      |SCL4         |HVSEL        |            |            |              |           |
        {53,        1},          //NC          |GPIO53             |DiSEqCo      |AGC2         |             |            |            |              |           |
        {54,        1},          //NC          |GPIO54             |AGC          |             |             |            |            |              |           |
        {55,        1},          //NC          |GPIO55             |SDA2         |SDA_T        |             |            |            |              |           |
        {56,        1},          //NC          |GPIO56             |SCL2         |SCL_T        |             |            |            |              |           |
        ...
        {86,        1},          //NC          |GPIO86             |RMRXD[0]     |PHY_CLK      |             |            |            |              |           |
        {87,        1},          //NC          |GPIO87             |MD           |PHY_CLK      |             |            |            |              |           |
        {90,        1},          //NC          |GPIO90             |MDC          |SPDIF        |PLL_OUT      |            |            |              |           |
        {91,        0},          //NC          |GPIO91             |NFRDY        |RMCRSDV      |PHY_CLK      |            |            |              |           |
        {92,        0},          //NC          |GPIO92             |NFOE         |RMTXEN       |             |            |            |              |           |
        {93,        0},          //NC          |GPIO93             |NFCLE        |RMTXD[1]     |             |            |            |              |           |
        {94,        0},          //NC          |GPIO94             |NFALE        |RMTXD[0]     |             |            |            |              |           |
        {95,        0},          //NC          |GPIO95             |NFWE         |RMCLK        |             |            |            |              |           |
        {96,        0},          //NC          |GPIO96             |NFDATA[7]    |RMRXD[1]     |             |            |            |              |           |
        {97,        0},          //NC          |GPIO97             |NFDATA[6]    |RMRXD[0]     |             |            |            |              |           |
