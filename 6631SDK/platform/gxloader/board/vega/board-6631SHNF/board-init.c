...
struct gpio_entry_bootloader g_gpio_table[] = {
	...
	{3,  67, GX_GPIO_CONFIG_VALID, GX_GPIO_OUTPUT, GX_GPIO_LOW},//mute control for cvbs, 0:mute; 1:unmute
	{5,  4, GX_GPIO_CONFIG_VALID, GX_GPIO_OUTPUT, GX_GPIO_HIGH},//LNB power, 1:enable, 0:disable
	{20, 3, GX_GPIO_CONFIG_VALID, GX_GPIO_INPUT,  GX_GPIO_LOW},//shortcut detect, 1:shortcut, 0:normal
	{13, 0, GX_GPIO_CONFIG_VALID, GX_GPIO_OUTPUT, GX_GPIO_HIGH},//power cont, 1:normal, 0:standby
