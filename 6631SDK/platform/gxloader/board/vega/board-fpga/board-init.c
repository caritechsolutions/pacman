...
/*       pin_id  func_sel                            fun0               fun1         fun2           fun3         fun4         fun5         fun6         fun7         */
        ...
        {11,        0},          //NC          |GPIO11 (PMUPORT11) |IR           |             |             |            |            |              |           |
#ifndef CONFIG_DBG_PIN_NO_MULTI
        {12,        0},          //NC          |GPIO12 (PMUPORT12) |DBGTDI       |             |             |            |            |              |           |
        {13,        0},          //NC          |GPIO13 (PMUPORT13) |DBGTDO       |             |             |            |            |              |           |
        {14,        0},          //NC          |GPIO14 (PMUPORT14) |DBGTMS       |             |             |            |            |              |           |
        {15,        0},          //NC          |GPIO15 (PMUPORT15) |DBGTCK       |             |             |            |            |              |           |
        {16,        0},          //NC          |GPIO16 (PMUPORT16) |DBGTRST      |CEC          |             |            |            |              |           |
#endif
        ...
        {22,        0},          //NC          |GPIO22             |TSI1DATA[2]  |TSODATA[2]   |SC1CLK       |ADCQDATA[5] |            |DBGTRST       |SC1CD      |
        ...
        {72,        0},          //NC          |GPIO72             |DDCSDA       |SDAS         |             |            |            |              |           |
        {73,        0},          //NC          |GPIO73             |DDCSCL       |SCLS         |             |            |            |              |           |
        {74,        0},          //NC          |GPIO74             |HPD          |             |             |            |            |              |           |
        ...
        {90,        0},          //NC          |GPIO90             |MDC          |SPDIF        |PLL_OUT      |            |            |              |           |
