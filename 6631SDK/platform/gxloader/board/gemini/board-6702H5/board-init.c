...
struct mulpin_config_s mulpin_table[] = {
 ...
 /*      size | chip_core_num | 0_bit | 1_bit | 2_bit | func_sel */ /* package_num | func_list */
        ...
        {_RIGHT_,    15,     27,          81,          137,       1},           //NC          |TSIDATA0/PORT13(PMUPORT13)/TSODATA0/I2SLRCK/ADCBIT2
        {_RIGHT_,    16,     28,          82,          138,       1},           //NC          |TSICLK/PORT14(PMUPORT14)/TSOCLK/I2SMCK/ADCBIT1
        {_RIGHT_,    17,     29,          83,          133,       1},           //NC          |TSISYNC/PORT15/TSOSYNC/UART2TX/ADCBIT0/SDA2
        {_RIGHT_,    18,     30,          84,          134,       1},           //NC          |TSIVALID/PORT16/TSOVALID/UART2RX/ADCCLK/SCL2
...
struct gpio_entry_bootloader g_gpio_table[] = {
	...
	{0,   14,  GX_GPIO_CONFIG_VALID, GX_GPIO_INPUT, GX_GPIO_LOW},//PANEL DATA
	{1,  13, GX_GPIO_CONFIG_VALID, GX_GPIO_OUTPUT, GX_GPIO_HIGH},//PANEL CLK
	{3,  11, GX_GPIO_CONFIG_VALID, GX_GPIO_OUTPUT, GX_GPIO_HIGH},//Mute
	//{12,  10, GX_GPIO_CONFIG_VALID, GX_GPIO_OUTPUT, GX_GPIO_HIGH},// Power LED
	//{13,  10, GX_GPIO_CONFIG_VALID, GX_GPIO_OUTPUT, GX_GPIO_HIGH},//Standby LED
	{15,  25,  GX_GPIO_CONFIG_VALID, GX_GPIO_INPUT,  GX_GPIO_HIGH},//ANT POWER
	{16,  12, GX_GPIO_CONFIG_VALID, GX_GPIO_OUTPUT, GX_GPIO_HIGH},//Power CNTL
	{17,  24,  GX_GPIO_CONFIG_VALID, GX_GPIO_INPUT,  GX_GPIO_HIGH},//SCART RGB
	{18,  15,  GX_GPIO_CONFIG_VALID, GX_GPIO_INPUT,  GX_GPIO_HIGH},//SCART SW
	{19,  16,  GX_GPIO_CONFIG_VALID, GX_GPIO_INPUT,  GX_GPIO_HIGH},//SCART TV
