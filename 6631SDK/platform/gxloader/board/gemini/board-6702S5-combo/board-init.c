...
struct mulpin_config_s mulpin_table[] = {
 ...
 /*      size | chip_core_num | 0_bit | 1_bit | 2_bit | func_sel */ /* package_num | func_list */
        ...
        {_BOTTOM_,   42,     15,          69,          MP_INV_V,  1},           //NC          |DBGTDI/PORT01(PMUPORT01)/SDBGTDI
        {_BOTTOM_,   43,     16,          70,          MP_INV_V,  1},           //NC          |DBGTDO/PORT02(PMUPORT02)/SDBGTDO
        {_BOTTOM_,   44,     17,          71,          MP_INV_V,  1},           //NC          |DBGTMS/PORT03(PMUPORT03)/SDBGTMS
        {_BOTTOM_,   45,     18,          72,          MP_INV_V,  1},           //NC          |DBGTCK/PORT04(PMUPORT04)/SDBGTCK
        {_BOTTOM_,   46,     19,          73,          MP_INV_V,  3},           //NC          |DBGTRST/PORT05(PMUPORT05)/SDBGTRST/CEC
#endif
        {_BOTTOM_,   47,     20,          74,          128,       3},           //NC          |TSIDATA7/PORT06(PMUPORT06)/TSODATA7/SC1CLK/ADCBIT9/SDBGTDI
        {_BOTTOM_,   48,     21,          75,          129,       3},           //NC          |TSIDATA6/PORT07(PMUPORT07)/TSODATA6/SC1RST/ADCBIT8/SDBGTDO/NC/I2SDATA
        {_BOTTOM_,   49,     22,          76,          130,       3},           //NC          |TSIDATA5/PORT08(PMUPORT08)/TSODATA5/SC1PWR/ADCBIT7/SDBGTMS/NC/I2SBCK
        {_BOTTOM_,   50,     23,          77,          131,       3},           //NC          |TSIDATA4/PORT09(PMUPORT09)/TSODATA4/SC1CD/ADCBIT6/SDBGTCK/NC/I2SLRCK
        {_RIGHT_,    1,      24,          78,          132,       3},           //NC          |TSIDATA3/PORT10(PMUPORT10)/TSODATA3/SC1DATA/ADCBIT5/SDBGTRST/NC/I2SMCK
        {_RIGHT_,    13,     25,          79,          135,       1},           //NC          |TSIDATA2/PORT11(PMUPORT11)/TSODATA2/I2SDATA/ADCBIT4
        {_RIGHT_,    14,     26,          80,          136,       1},           //NC          |TSIDATA1/PORT12(PMUPORT12)/TSODATA1/I2SBCK/ADCBIT3
        ...
        {_RIGHT_,    37,     38,          90,          MP_INV_V,  1},           //NC          |SDA2/PORT24/ADCRDY
        {_RIGHT_,    38,     39,          91,          MP_INV_V,  1},           //NC          |SCL2/PORT25/ADCSYNC
        {_RIGHT_,    39,     40,          MP_INV_V,    MP_INV_V,  1},           //NC          |AGC2/PORT26
#ifdef PCDEMO_SUPPORT
        {_RIGHT_,    44,     41,          85,          MP_INV_V,  2},           //NC          |SDA1/PORT27/SDAT
        {_RIGHT_,    45,     42,          86,          MP_INV_V,  2},           //NC          |SCL1/PORT28/SCLT
#else
...
#ifdef PCDEMO_SUPPORT
        {_LEFT_,     7,      44,          87,          MP_INV_V,  2},           //NC          |DDCSDA/PORT38/SDAS
        {_LEFT_,     8,      45,          88,          MP_INV_V,  2},           //NC          |DDCSCL/PORT39/SCLS
#else
	...
	/* PORT43 ~ PORT45 默认为普通GPIO功能,无需管脚复用 */
        ...
        {_BOTTOM_,   26,     9,           67,          MP_INV_V,  1},           //NC          |SC1CLK/PORT56/SDA2
        {_BOTTOM_,   27,     10,          68,          MP_INV_V,  1},           //NC          |SC1RST/PORT57/SCL2
        {_BOTTOM_,   29,     11,          MP_INV_V,    MP_INV_V,  1},           //NC          |SC1PWR/PORT58
        {_BOTTOM_,   20,     12,          MP_INV_V,    MP_INV_V,  1},           //NC          |SC1CD/PORT59
        {_BOTTOM_,   30,     13,          MP_INV_V,    MP_INV_V,  1},           //NC          |SC1DATA/PORT60
...
struct gpio_entry_bootloader g_gpio_table[] = {
	{1,   1,   GX_GPIO_CONFIG_VALID, GX_GPIO_OUTPUT,  GX_GPIO_LOW},//PANEL_CLK
	{0,   2,   GX_GPIO_CONFIG_VALID, GX_GPIO_INPUT,  GX_GPIO_LOW},//PANEL_DATA
	{20,  3,   GX_GPIO_CONFIG_VALID, GX_GPIO_INPUT,   GX_GPIO_LOW},//LNB_SHORT
	{10,  4,   GX_GPIO_CONFIG_VALID, GX_GPIO_OUTPUT,  GX_GPIO_LOW},//TUNER2_RST 1:normal 0:reset
	{3,  11,   GX_GPIO_CONFIG_VALID, GX_GPIO_OUTPUT,  GX_GPIO_LOW},//MUTE_CTRL 1:mute 0:unmute
	{11, 12,   GX_GPIO_CONFIG_VALID, GX_GPIO_OUTPUT,  GX_GPIO_HIGH},//POWER_CONT 1:power up 0:power down
	{4,  24,   GX_GPIO_CONFIG_VALID, GX_GPIO_OUTPUT,  GX_GPIO_LOW},//LNB_POWER_EN 1:OFF 0:ON
	{15, 25,   GX_GPIO_CONFIG_VALID, GX_GPIO_OUTPUT,  GX_GPIO_HIGH},//ANT_POWER/SHORT 1:ANT_POWER ON 0:ANT_POWER OFF
...
#endif
#ifdef PCDEMO_SUPPORT
    *(volatile unsigned int*)(0xa030a150) |= (0x1<<27);
#endif
	ts_mode_config(1, 1, 0x88, 0, 1, 1, 1);//set ts1 to serial ts
