...
struct mulpin_config_s mulpin_table[] = {
 ...
 /* chip_core_num | l_bit | h_bit | func_select */    /* package_num | func_list */
	...
	{112, 23, 80, 0},                             // NC          | AJTDI_SC1DET_GBADDR11_PORT23
	{113, 22, 81, 0},                             // NC          | AJTDO_SC1PWR_GBADDR12_PORT22
	{115, 16, 82, 0},                             // NC          | AJTMS_SC1DAT_GBADDR13_PORT16
	{116, 15, 83, 0},                             // NC          | AJTCK_SC1CLK_GBADDR14_PORT15
	{117, 14, 84, 0},                             // NC          | AJTRST_SC1RST_GBADDR15_PORT14
#ifndef CONFIG_DBG_PIN_NO_MULTI
	{118, 32, MULPIN_INVALID_VALUE, 0},           // NC          | DBGTDI_PORT32
	{119, 33, MULPIN_INVALID_VALUE, 0},           // NC          | DBGTDO_PORT33
	{120, 34, MULPIN_INVALID_VALUE, 0},           // NC          | DBGTMS_PORT34
	{121, 35, MULPIN_INVALID_VALUE, 0},           // NC          | DBGTCK_PORT35
	{122, 36, MULPIN_INVALID_VALUE, 0},           // NC          | DBGTRST_PORT36
#endif
	{124, 37, MULPIN_INVALID_VALUE, 0},           // NC          | TS1VALID_PORT37
	{125, 38, MULPIN_INVALID_VALUE, 0},           // NC          | TS1DAT0_PORT38
	{126, 39, 87, 0},                             // NC          | ScanPwdClk_PORT39_TS1DTA1
	{127, 40, 87, 0},                             // NC          | ScanPwdDat_PORT40_TS1DAT2
	{128, 41, 87, 0},                             // NC          | ScanPwdSel_PORT41_TS1DAT3
	{129, 42, 89, 0},                             // NC          | UARTTXICAM1_PORT42_TS1DAT4
	{130, 43, 89, 0},                             // NC          | UARTRXICAM1_PORT43_TS1DAT5
	{131, 44, 89, 0},                             // NC          | UARTTXICAM2_PORT44_TS1DAT6
	{132, 45, 89, 0},                             // NC          | UARTRXICAM2_PORT45_TS1DAT7
	{133, 46, 89, 0},                             // NC          | UARTTXICAM3_PORT46_TS1CLK
	{134, 47, 89, 0},                             // NC          | UARTRXICAM3_PORT47_TS1SYNC
	...
	{156, 61, MULPIN_INVALID_VALUE, 0},           // NC          | AGC_PORT61
	{221, 62, 79, 0},                             // NC          | SPDIF_PORT62_OtpClockOsc
	{222, 63, 85, 0},                             // NC          | UARTTX1_PORT63_AUARTTX
	{223, 64, MULPIN_INVALID_VALUE, 0},           // NC          | UARTRX1_PORT64
