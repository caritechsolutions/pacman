...
struct mulpin_config_s mulpin_table[] = {
 ...
 /*      size | chip_core_num | 0_bit | 1_bit | 2_bit | func_sel */ /* package_num | func_list */
	...
	/* PORT10 ~ PORT14 默认为普通GPIO功能,无需管脚复用 */
        ...
        {_BOTTOM_,   53,     9,           65,          MP_INV_V,  0},           //NC          |DBGTDI/PORT16(PMUPORT01)/TSOUT8/SDBGTDI
        {_BOTTOM_,   54,     10,          66,          MP_INV_V,  0},           //NC          |DBGTDO/PORT17(PMUPORT02)/TSOUT9/SDBGTDO
        {_BOTTOM_,   55,     11,          67,          MP_INV_V,  0},           //NC          |DBGTMS/PORT18(PMUPORT03)/TSOUT10/SDBGTMS
        {_BOTTOM_,   56,     12,          68,          MP_INV_V,  0},           //NC          |DBGTCK/PORT19(PMUPORT04)/SDBGTCK
        {_BOTTOM_,   57,     13,          69,          MP_INV_V,  0},           //NC          |DBGTRST/PORT20(PMUPORT05)/SDBGTRST/CEC
#endif
