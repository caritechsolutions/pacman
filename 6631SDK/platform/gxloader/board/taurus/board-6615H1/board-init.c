...
struct mulpin_config_s mulpin_table[] = {
 ...
 /*      size | chip_core_num | 0_bit | 1_bit | 2_bit | func_sel */ /* package_num | func_list */
	...
	/* PORT10 ~ PORT14 默认为普通GPIO功能,无需管脚复用 */
        ...
        {_RIGHT_,    14,     20,          76,          MP_INV_V,  1},           //NC          |HVSEL/PORT27/TSIDATA1
        {_RIGHT_,    15,     21,          77,          MP_INV_V,  1},           //NC          |DiSEqCo/PORT28/TSIDATA0
        {_RIGHT_,    16,     22,          78,          MP_INV_V,  1},           //NC          |AGC/PORT29/TSICLK
        ...
        {_RIGHT_,    42,     36,          92,          MP_INV_V,  0},           //NC          |HVSEL/PORT43
        {_RIGHT_,    43,     37,          MP_INV_V,    MP_INV_V,  0},           //NC          |DiSEqCo/PORT44
        {_RIGHT_,    44,     38,          MP_INV_V,    MP_INV_V,  0},           //NC          |AGC/PORT45
...
/*	{9,   5,  GX_GPIO_CONFIG_VALID, GX_GPIO_OUTPUT, GX_GPIO_HIGH},
	...
	{5,   76, GX_GPIO_CONFIG_VALID, GX_GPIO_OUTPUT, GX_GPIO_LOW},//LNB_POWER_EN  0:on  1:off
	{11,  16, GX_GPIO_CONFIG_VALID, GX_GPIO_OUTPUT, GX_GPIO_HIGH},//POWER_CONTRL for standby  0:standby  1:normal
	...
	{3,   3, GX_GPIO_CONFIG_VALID, GX_GPIO_OUTPUT, GX_GPIO_HIGH},//Mute control 0:unmute 1:mute
	{25,  78, GX_GPIO_CONFIG_VALID, GX_GPIO_INPUT, GX_GPIO_LOW},//LNB Shortcut  0:normal 1:shortcut
	{7,   79, GX_GPIO_CONFIG_VALID, GX_GPIO_OUTPUT, GX_GPIO_HIGH},//ETHERNETRST 0:reset  1:normal
