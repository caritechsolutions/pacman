...
struct mulpin_config_s mulpin_table[] = {
 ...
 /*      size | chip_core_num | 0_bit | 1_bit | 2_bit | func_sel */ /* package_num | func_list */
	...
	/* PORT10 ~ PORT14 默认为普通GPIO功能,无需管脚复用 */
		...
		{_BOTTOM_,   56,     12,          68,          MP_INV_V,  1},           //NC          |DBGTCK/PORT19(PMUPORT04)/SDBGTCK
		{_BOTTOM_,   57,     13,          69,          MP_INV_V,  3},           //NC          |DBGTRST/PORT20(PMUPORT05)/SDBGTRST/CEC
#endif
		{_RIGHT_,    5,      14,          70,          128,       1},           //NC          |SC1CLK/PORT21/TSIDATA7/SDBGTDI/DEVADDR0
		{_RIGHT_,    6,      15,          71,          129,       1},           //NC          |SC1RST/PORT22/TSIDATA6/SDBGTDO
		{_RIGHT_,    7,      16,          72,          130,       0},           //NC          |SC1PWR/PORT23/TSIDATA5/SDBGTMS
		{_RIGHT_,    8,      17,          73,          131,       1},           //NC          |SC1CD/PORT24/TSIDATA4/SDBGTCK
		{_RIGHT_,    9,      18,          74,          132,       1},           //NC          |SC1DATA/PORT25/TSIDATA3/SDBGTRST
		{_RIGHT_,    13,     19,          75,          MP_INV_V,  2},           //NC          |NULL/PORT26/TSIDATA2/DEVADDR1
		{_RIGHT_,    14,     20,          76,          MP_INV_V,  2},           //NC          |HVSEL/PORT27/TSIDATA1
...
/*	{9,   5,  GX_GPIO_CONFIG_VALID, GX_GPIO_OUTPUT, GX_GPIO_HIGH},
	...
	{5,   19, GX_GPIO_CONFIG_VALID, GX_GPIO_OUTPUT, GX_GPIO_LOW},//LNB_POWER_EN  0:on  1:off
	{11,  16, GX_GPIO_CONFIG_VALID, GX_GPIO_OUTPUT, GX_GPIO_HIGH},//POWER_CONTRL  0:off  1:on
	{0,   17, GX_GPIO_CONFIG_VALID, GX_GPIO_INPUT, GX_GPIO_LOW},//PANEL_SDA
	{1,   18, GX_GPIO_CONFIG_VALID, GX_GPIO_OUTPUT, GX_GPIO_LOW},//PANEL_CLK
	{15,   21, GX_GPIO_CONFIG_VALID, GX_GPIO_OUTPUT, GX_GPIO_LOW},//T2 ANT 0:off 1:on
	{13,   24, GX_GPIO_CONFIG_VALID, GX_GPIO_OUTPUT, GX_GPIO_HIGH},//13/18V 0:13 1:18
	{14,   22, GX_GPIO_CONFIG_VALID, GX_GPIO_OUTPUT, GX_GPIO_LOW},//ATBM7821 reset
	{20,   25, GX_GPIO_CONFIG_VALID, GX_GPIO_INPUT, GX_GPIO_LOW},//LNB Short 0: normal 1: short
...
extern int usb_recover_proc(void);
	...
	ts_mode_config(1, 1, 0x113, 0, 1, 1, 1);	//set ts1 to serial ts, and mode is 2, no valid, sync, little endian
