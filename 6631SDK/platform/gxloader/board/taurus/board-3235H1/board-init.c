...
struct mulpin_config_s mulpin_table[] = {
 ...
 /*      size | chip_core_num | 0_bit | 1_bit | 2_bit | func_sel */ /* package_num | func_list */
	...
	/* PORT10 ~ PORT14 默认为普通GPIO功能,无需管脚复用 */
        ...
        {_RIGHT_,    15,     21,          77,          MP_INV_V,  2},           //NC          |DiSEqCo/PORT28/TSIDATA0
        {_RIGHT_,    16,     22,          78,          MP_INV_V,  2},           //NC          |AGC/PORT29/TSICLK
...
/*	{9,   5,  GX_GPIO_CONFIG_VALID, GX_GPIO_OUTPUT, GX_GPIO_HIGH},
	...
	{3 ,  19, GX_GPIO_CONFIG_VALID, GX_GPIO_OUTPUT, GX_GPIO_HIGH},
...
extern int usb_recover_proc(void);
	...
	ts_mode_config(1, 1, 0x113, 0, 1, 1, 1);	//set ts1 to serial ts, and mode is 3, no valid, sync, big endian
