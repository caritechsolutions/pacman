...
/*       pin_id  func_sel                     func_list */
        ...
        {20,      0},          //NC          |PORT20(PMUPORT03)/DBGTDI/SDBGTDI/ADBGTDI/ADCCLK/TSOUT10
        ...
        {32,      2},          //NC          |PORT32/SCL2/TSIDATA0/TSODATA0/MD
        {33,      0},          //NC          |PORT33
        {34,      2},          //NC          |PORT34/AGC/TSICLK/TSOCLK/FM_AGC/MDC
        {35,      2},          //NC          |PORT35/UART2TX/TSISYNC/TSOSYNC/RMTXEN/SUARTTX/AUARTTX
...
struct gpio_entry_bootloader g_gpio_table[] = {
    ...
    {15,    23,    GX_GPIO_CONFIG_VALID,    GX_GPIO_INPUT,  GX_GPIO_HIGH},//ANT POWER`
    {20,    20,    GX_GPIO_CONFIG_VALID,    GX_GPIO_INPUT, GX_GPIO_LOW}, //LNB SHORT
    {5,     49,    GX_GPIO_CONFIG_VALID,    GX_GPIO_OUTPUT, GX_GPIO_LOW}, //LNB POWER
	{16,    25,    GX_GPIO_CONFIG_VALID,    GX_GPIO_OUTPUT, GX_GPIO_HIGH},//Power CNTL
	{10,    48,    GX_GPIO_CONFIG_VALID,    GX_GPIO_OUTPUT, GX_GPIO_LOW},//Demod 1137 RST
