...
#define DDR_ADDR_OUTPUT_DRIVER 0x3
	*(volatile unsigned int*)(CONFIG_BASE+CONFIG_DRAM_CONFIG0) |= (DDR_OUTPUT_DRIVER<<3)\
		| (DDR_OUTPUT_DRIVER<<6) | (DDR_OUTPUT_DRIVER<<16) | (DDR_OUTPUT_DRIVER<<19)\
		| (DDR_ADDR_OUTPUT_DRIVER<<22) | (DDR_ADDR_OUTPUT_DRIVER<<25) | (DDR_ADDR_OUTPUT_DRIVER<<28); //feed, odt, dm, cmd

	*(volatile unsigned int*)(CONFIG_BASE+CONFIG_DRAM_CONFIG1) |= (DDR_OUTPUT_DRIVER<<0)\
		| (DDR_OUTPUT_DRIVER<<11); //dqs and clk

	*(volatile unsigned int*)(CONFIG_BASE+CONFIG_DRAM_CONFIG2) |= (DDR_ADDR_OUTPUT_DRIVER<<11); //cmmd

	*(volatile unsigned int*)(CONFIG_BASE+CONFIG_DRAM_CONFIG3) |= (DDR_OUTPUT_DRIVER<<16)\
		| (DDR_OUTPUT_DRIVER<<20) | (DDR_OUTPUT_DRIVER<<24) |(DDR_OUTPUT_DRIVER<<28); //dq

	*(volatile unsigned int*)(CONFIG_BASE+CONFIG_DRAM_CONFIG5) |= (DDR_ADDR_OUTPUT_DRIVER<<0)\
		|(DDR_ADDR_OUTPUT_DRIVER<<3) |(DDR_ADDR_OUTPUT_DRIVER<<6) |(DDR_ADDR_OUTPUT_DRIVER<<9)\
		|(DDR_ADDR_OUTPUT_DRIVER<<12) |(DDR_ADDR_OUTPUT_DRIVER<<15) |(DDR_ADDR_OUTPUT_DRIVER<<18)\
		|(DDR_ADDR_OUTPUT_DRIVER<<21) |(DDR_ADDR_OUTPUT_DRIVER<<24) |(DDR_ADDR_OUTPUT_DRIVER<<27); //addr

	*(volatile unsigned int*)(CONFIG_BASE+CONFIG_DRAM_CONFIG6) |= (DDR_ADDR_OUTPUT_DRIVER<<0)\
		|(DDR_ADDR_OUTPUT_DRIVER<<3) |(DDR_ADDR_OUTPUT_DRIVER<<6) |(DDR_ADDR_OUTPUT_DRIVER<<9)\
		|(DDR_ADDR_OUTPUT_DRIVER<<12) |(DDR_ADDR_OUTPUT_DRIVER<<16) |(DDR_ADDR_OUTPUT_DRIVER<<19)
		|(DDR_ADDR_OUTPUT_DRIVER<<22); //addr, ba
}

void __attribute__((section(".reset_patch"))) ddr_config_patch_6706H1(void)
{
#define DDR_OUTPUT_DRIVER_6706H1 0x6
#define DDR_ADDR_OUTPUT_DRIVER_6706H1 0x4
	*(volatile unsigned int*)(CONFIG_BASE+CONFIG_DRAM_CONFIG0) |= (DDR_OUTPUT_DRIVER_6706H1<<3) | (DDR_OUTPUT_DRIVER_6706H1<<6) | (DDR_OUTPUT_DRIVER_6706H1<<16) | (DDR_OUTPUT_DRIVER_6706H1<<19) | (DDR_OUTPUT_DRIVER_6706H1<<22) | (DDR_OUTPUT_DRIVER_6706H1<<25) | (DDR_OUTPUT_DRIVER_6706H1<<28); //feed, odt, dm, cmd
	*(volatile unsigned int*)(CONFIG_BASE+CONFIG_DRAM_CONFIG1) |= (DDR_OUTPUT_DRIVER_6706H1<<0) | (DDR_OUTPUT_DRIVER_6706H1<<11); //dqs and clk
	*(volatile unsigned int*)(CONFIG_BASE+CONFIG_DRAM_CONFIG2) |= (DDR_ADDR_OUTPUT_DRIVER_6706H1<<11); //cmmd
	*(volatile unsigned int*)(CONFIG_BASE+CONFIG_DRAM_CONFIG3) |= (DDR_OUTPUT_DRIVER_6706H1<<16) | (DDR_OUTPUT_DRIVER_6706H1<<20) | (DDR_OUTPUT_DRIVER_6706H1<<24) |(DDR_OUTPUT_DRIVER_6706H1<<28); //dq
	*(volatile unsigned int*)(CONFIG_BASE+CONFIG_DRAM_CONFIG5) |= (DDR_ADDR_OUTPUT_DRIVER_6706H1<<0) |(DDR_ADDR_OUTPUT_DRIVER_6706H1<<3) |(DDR_ADDR_OUTPUT_DRIVER_6706H1<<6) |(DDR_ADDR_OUTPUT_DRIVER_6706H1<<9) |(DDR_ADDR_OUTPUT_DRIVER_6706H1<<12) |(DDR_ADDR_OUTPUT_DRIVER_6706H1<<15) |(DDR_ADDR_OUTPUT_DRIVER_6706H1<<18) |(DDR_ADDR_OUTPUT_DRIVER_6706H1<<21) |(DDR_ADDR_OUTPUT_DRIVER_6706H1<<24) |(DDR_ADDR_OUTPUT_DRIVER_6706H1<<27); //addr
	*(volatile unsigned int*)(CONFIG_BASE+CONFIG_DRAM_CONFIG6) |= (DDR_ADDR_OUTPUT_DRIVER_6706H1<<0) |(DDR_ADDR_OUTPUT_DRIVER_6706H1<<3) |(DDR_ADDR_OUTPUT_DRIVER_6706H1<<6) |(DDR_ADDR_OUTPUT_DRIVER_6706H1<<9) |(DDR_ADDR_OUTPUT_DRIVER_6706H1<<12) |(DDR_ADDR_OUTPUT_DRIVER_6706H1<<16) |(DDR_ADDR_OUTPUT_DRIVER_6706H1<<19) |(DDR_ADDR_OUTPUT_DRIVER_6706H1<<22); //addr, ba
}
...
/*       pin_id  func_sel                     func_list */
        ...
        {23,      0},          //NC          |PORT23(PMUPORT06)/DBGTCK/SDBGTCK/ADBGTCK/ADCBIT7/TSOUT7
        ...
        {33,      0},          //NC          |PORT33
        {34,      1},          //NC          |PORT34/AGC/TSICLK/TSOCLK/FM_AGC/MDC
        ...
        {37,      1},          //NC          |PORT37/SDA1/SDAT/RMTXD0
        ...
        {46,      0},          //NC          |PORT46/SDA1
        {47,      0},          //NC          |PORT47/SCL1
        {48,      0},          //NC          |PORT48/SDA2/SDAT/RMRXD1
        {49,      0},          //NC          |PORT49/SCL2/SCLT/RMRXD0
        {50,      0},          //NC          |PORT50/AGC/FM_AGC
        ...
        {60,      1},          //NC          |PORT60/RMCRSDV
        {61,      1},          //NC          |PORT61/MD
        {62,      1},          //NC          |PORT62/MDC
        {63,      1},          //NC          |PORT63/RMTXEN
        {64,      1},          //NC          |PORT64/RMTXD1
        {65,      1},          //NC          |PORT65/RMTXD0
        {66,      1},          //NC          |PORT66/RMCLK
        {67,      1},          //NC          |PORT67/RMRXD1
        {68,      1},          //NC          |PORT68/RMRXD0
...
struct gpio_entry_bootloader g_gpio_table[] = {
	...
	{15,    23,    GX_GPIO_CONFIG_VALID,    GX_GPIO_OUTPUT,  GX_GPIO_LOW}, //ANT POWER AND LNB SHORT
...
int board_init(void)
{
	...
	cmdline_clear();
	if (strncmp((const char *)gx_get_chip_name(), "6706H1", 6) == 0) {
		printf("6706H1");
