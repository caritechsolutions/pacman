...
#define DDR_OUTPUT_DRIVER 0x6
	...
	*(volatile unsigned int*)(CONFIG_BASE+CONFIG_DRAM_CONFIG2) |= (4<<0) | (4<<11);
}
...
struct mulpin_config_s mulpin_table[] = {
 ...
 /*      size | chip_core_num | 0_bit | 1_bit | 2_bit | func_sel */ /* package_num | func_list */
        ...
        {_RIGHT_,    13,     42,    101,         MP_INV_V,  1},           //NC          |PORT10(PMUPORT09)/SC1CLK/TSI1DATA0/TSODATA0
        {_RIGHT_,    14,     43,    102,         MP_INV_V,  0},           //NC          |PORT11/SC1RST/TSI1DATA1/TSODATA1
        ...
        {_RIGHT_,    38,     52,    120,         MP_INV_V,  1},           //NC          |PORT20/TSI2VALID/TSOVALID
        {_RIGHT_,    39,     53,    120,         MP_INV_V,  1},           //NC          |PORT21/TSI2DATA0/TSODATA0
        {_RIGHT_,    40,     54,    120,         MP_INV_V,  1},           //NC          |PORT22/TSI2DATA1/TSODATA1
        {_RIGHT_,    41,     55,    120,         MP_INV_V,  1},           //NC          |PORT23/TSI2DATA2/TSODATA2
        {_RIGHT_,    42,     56,    120,         MP_INV_V,  1},           //NC          |PORT24/TSI2DATA3/TSODATA3
        {_RIGHT_,    44,     57,    120,         MP_INV_V,  1},           //NC          |PORT25/TSI2DATA4/TSODATA4
        {_RIGHT_,    45,     58,    120,         MP_INV_V,  1},           //NC          |PORT26/TSI2DATA5/TSODATA5
        {_RIGHT_,    46,     59,    120,         MP_INV_V,  1},           //NC          |PORT27/TSI2DATA6/TSODATA6
        {_RIGHT_,    47,     60,    120,         MP_INV_V,  1},           //NC          |PORT28/TSI2DATA7/TSODATA7
        {_RIGHT_,    48,     61,    120,         MP_INV_V,  1},           //NC          |PORT29/TSI2SCLK/TSOCLK
        {_RIGHT_,    50,     62,    120,         MP_INV_V,  1},           //NC          |PORT30/TSI2SYNC/TSOSYNC
        {_RIGHT_,    51,     63,    MP_INV_V,    MP_INV_V,  1},           //NC          |PORT31(PMUPORT18)/SDA2
        {_RIGHT_,    52,     64,    MP_INV_V,    MP_INV_V,  1},           //NC          |PORT32(PMUPORT19)/SCL2
        {_RIGHT_,    53,     65,    111,         MP_INV_V,  1},           //NC          |PORT33(PMUPORT20)/UART2TX/AUARTTX
        {_RIGHT_,    54,     66,    112,         MP_INV_V,  1},           //NC          |PORT34(PMUPORT21)/UART2RX
        ...
        {_RIGHT_,    58,     69,    115,         MP_INV_V,  0},           //NC          |PORT37(PMUPORT24)/AGC1/AGC2
        ...
        {_TOP_,      84,     76,    MP_INV_V,    MP_INV_V,  0},           //NC          |PORT44/SPDIF
        ...
        {_LEFT_,     35,     86,    MP_INV_V,    MP_INV_V,  1},           //NC          |PORT70(GBPORT06)/NFRDY0
                                                                          //NC          |PORT71(GBPORT07)/NFOE
                                                                          //NC          |PORT72(GBPORT08)/NFCLE
                                                                          //NC          |PORT73(GBPORT09)/NFALE
                                                                          //NC          |PORT74(GBPORT10)/NFWE
        {_LEFT_,     41,     88,    MP_INV_V,    MP_INV_V,  1},           //NC          |PORT75(GBPORT11)/NFDATA7
...
struct gpio_entry_bootloader g_gpio_table[] = {
	{11, 11, GX_GPIO_CONFIG_VALID, GX_GPIO_OUTPUT, GX_GPIO_HIGH}, //HSM Reset
	{14, 14, GX_GPIO_CONFIG_VALID, GX_GPIO_OUTPUT, GX_GPIO_HIGH}, //GX1121D GX1503B Reset
	{15, 15, GX_GPIO_CONFIG_VALID, GX_GPIO_OUTPUT, GX_GPIO_HIGH}, //HSM
	{35, 35, GX_GPIO_CONFIG_VALID, GX_GPIO_OUTPUT, GX_GPIO_HIGH}, //GX1121D HV Select
	{37, 37, GX_GPIO_CONFIG_VALID, GX_GPIO_OUTPUT, GX_GPIO_HIGH}, //Beidou Reset
	{44, 44, GX_GPIO_CONFIG_VALID, GX_GPIO_OUTPUT, GX_GPIO_HIGH}, //CVBS Audio MUTE
	{83, 83, GX_GPIO_CONFIG_VALID, GX_GPIO_OUTPUT, GX_GPIO_LOW}, //SPEAKER MUTE
	{64, 64, GX_GPIO_CONFIG_VALID, GX_GPIO_OUTPUT, GX_GPIO_HIGH}, //PANEL LOCK LED
	{66, 66, GX_GPIO_CONFIG_VALID, GX_GPIO_INPUT, GX_GPIO_HIGH},  //PANEL KEY0
	{67, 67, GX_GPIO_CONFIG_VALID, GX_GPIO_OUTPUT, GX_GPIO_HIGH}, //PANEL CLK
	{68, 68, GX_GPIO_CONFIG_VALID, GX_GPIO_OUTPUT, GX_GPIO_HIGH}, //PANEL DATA
...
extern int usb_recover_proc(void);
	...
	//DTMB
	ts_mode_config(1, 1, 3, 0, 1, 1, -1);	//set ts1 to serial ts, and mode is 3, no valid, sync, big endian
...
#if 1
	/*
	*  1: 180000000 from APB2_3 clock(for smartcard)
...
#endif
	*(volatile unsigned int*)(CONFIG_BASE_MMU + CONFIG_MPEG_CLK_INHIBIT2_NORM ) |= 1 << 18; // close gp clock
	*(volatile unsigned int*)(CONFIG_BASE_MMU + CONFIG_MPEG_CLK_INHIBIT2_NORM ) |= 1 << 2; // close gp denali clock
	*(volatile unsigned int*)(CONFIG_BASE_MMU + CONFIG_MPEG_CLK_INHIBIT2_NORM ) |= 1 << 16; // close gse clock`
	*(volatile unsigned int*)(CONFIG_BASE_MMU + CONFIG_MPEG_CLK_INHIBIT2_NORM ) |= 1 << 17; // close pidfilter clock`
}
