...
struct mulpin_config_s mulpin_table[] = {
 ...
 /*      size | chip_core_num | 0_bit | 1_bit | 2_bit | func_sel */ /* package_num | func_list */
        ...
        {_RIGHT_,    56,     67,    113,         132,       4},           //NC          |PORT35(PMUPORT22)/HVSEL/SDA3/NFDAT1/DiSEqCi
        ...
        {_TOP_,      85,     77,    MP_INV_V,    MP_INV_V,  1},           //NC          |PORT45/SPD_LED
...
struct gpio_entry_bootloader g_gpio_table[] = {
    ...
    {0,  31, GX_GPIO_CONFIG_VALID, GX_GPIO_INPUT, GX_GPIO_LOW},// fd650, sda
	{1,  32, GX_GPIO_CONFIG_VALID, GX_GPIO_OUTPUT, GX_GPIO_HIGH},// fd650, clk
	{3,   11, GX_GPIO_CONFIG_VALID, GX_GPIO_OUTPUT, GX_GPIO_HIGH},//mute control for cvbs, 1:mute; 0:unmute
	{10,  19, GX_GPIO_CONFIG_VALID, GX_GPIO_INPUT,  GX_GPIO_LOW},//shortcut detect, 1:shortcut, 0:normal
	{11,  10, GX_GPIO_CONFIG_VALID, GX_GPIO_OUTPUT, GX_GPIO_HIGH},//LED for power and standby, 1: power led display, 0:standby led display
	{16,  33, GX_GPIO_CONFIG_VALID, GX_GPIO_OUTPUT, GX_GPIO_HIGH},//power cont
	{5,   18, GX_GPIO_CONFIG_VALID, GX_GPIO_OUTPUT, GX_GPIO_LOW},//LNB power, 0:enable, 1:disable
	{30,  12, GX_GPIO_CONFIG_VALID, GX_GPIO_OUTPUT, GX_GPIO_HIGH},//remote led (flicker with key), 0:
	{13,   13, GX_GPIO_CONFIG_VALID, GX_GPIO_OUTPUT, GX_GPIO_LOW},//lnb 13/18 0 - 13V; 1 - 18V
	{14,   16, GX_GPIO_CONFIG_VALID, GX_GPIO_OUTPUT, GX_GPIO_LOW},//SI2168 reset
