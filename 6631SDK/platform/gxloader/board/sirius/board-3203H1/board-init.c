...
struct mulpin_config_s mulpin_table[] = {
 ...
 /*      size | chip_core_num | 0_bit | 1_bit | 2_bit | func_sel */ /* package_num | func_list */
        ...
        {_RIGHT_,    56,     67,    113,         132,       0},           //NC          |PORT35(PMUPORT22)/HVSEL/SDA3/NFDAT1/DiSEqCi
        {_RIGHT_,    57,     68,    114,         MP_INV_V,  0},           //NC          |PORT36(PMUPORT23)/DiSEqCo/SCL3/NFDAT0
        ...
        {_RIGHT_,    64,     80,    MP_INV_V,    MP_INV_V,  0},           //NC          |PORT48(PMUPORT29)/CEC
...
/*	{9 ,  1, GX_GPIO_CONFIG_VALID, GX_GPIO_OUTPUT, GX_GPIO_HIGH},
	...
	{0 ,  18, GX_GPIO_CONFIG_VALID, GX_GPIO_OUTPUT, GX_GPIO_HIGH},
	{1 ,  17, GX_GPIO_CONFIG_VALID, GX_GPIO_OUTPUT, GX_GPIO_HIGH},
	{3 ,  16, GX_GPIO_CONFIG_VALID, GX_GPIO_OUTPUT, GX_GPIO_HIGH},
	{12 ,  35, GX_GPIO_CONFIG_VALID, GX_GPIO_OUTPUT, GX_GPIO_HIGH},
	{13 ,  36, GX_GPIO_CONFIG_VALID, GX_GPIO_OUTPUT, GX_GPIO_LOW},
	{14 ,  1, GX_GPIO_CONFIG_VALID, GX_GPIO_OUTPUT, GX_GPIO_HIGH},
