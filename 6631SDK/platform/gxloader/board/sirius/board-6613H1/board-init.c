...
/*	{9 ,  1, GX_GPIO_CONFIG_VALID, GX_GPIO_OUTPUT, GX_GPIO_HIGH},
	...
	{3,   1, GX_GPIO_CONFIG_VALID, GX_GPIO_OUTPUT, GX_GPIO_HIGH},//mute control for cvbs, 1:mute; 0:unmute
	{10,  2, GX_GPIO_CONFIG_VALID, GX_GPIO_INPUT,  GX_GPIO_LOW},//shortcut detect, 1:shortcut, 0:normal
	...
	{5,  5, GX_GPIO_CONFIG_VALID, GX_GPIO_OUTPUT, GX_GPIO_LOW},//LNB power, 0:enable, 1:disable
	{15,  45, GX_GPIO_CONFIG_VALID, GX_GPIO_OUTPUT, GX_GPIO_HIGH},//1: NDS_CA(default), 0:CI
	{30,  34, GX_GPIO_CONFIG_VALID, GX_GPIO_OUTPUT, GX_GPIO_HIGH},//remote led (flicker with key), 0:light up, 1:light off
