...
struct mulpin_config_s mulpin_table[] = {
 ...
 /*      size | chip_core_num | 0_bit | 1_bit | 2_bit | func_sel */ /* package_num | func_list */
        ...
        {_RIGHT_,    2,      34,    123,         MP_INV_V,  1},           //NC          |DBGDTO/PORT02(PMUPORT02)/CEC
        {_RIGHT_,    3,      35,    96,          MP_INV_V,  1},           //NC          |DBGTMS/PORT03(PMUPORT03)/NFRDY0
        {_RIGHT_,    4,      36,    96,          MP_INV_V,  1},           //NC          |DBGTCK/PORT04(PMUPORT04)/NFOE
        ...
        {_RIGHT_,    11,     41,    122,         MP_INV_V,  1},           //NC          |PORT09/TSI1VALID/TSOVALID
        {_RIGHT_,    13,     42,    101,         MP_INV_V,  2},           //NC          |PORT10(PMUPORT09)/SC1CLK/TSI1DATA0/TSODATA0
        {_RIGHT_,    14,     43,    102,         MP_INV_V,  2},           //NC          |PORT11(PMUPORT10)/SC1RST/TSI1DATA1/TSODATA1
        {_RIGHT_,    15,     44,    103,         MP_INV_V,  2},           //NC          |PORT12(PMUPORT11)/SC1PWR/TSI1DATA2/TSODATA2
        {_RIGHT_,    16,     45,    104,         MP_INV_V,  2},           //NC          |PORT13(PMUPORT12)/SC1CD/TSI1DATA3/TSODATA3
        {_RIGHT_,    17,     46,    105,         MP_INV_V,  2},           //NC          |PORT14(PMUPORT13)/SC1DATA/TSI1DATA4/TSODATA4
        {_RIGHT_,    19,     47,    106,         133,       2},           //NC          |PORT15(PMUPORT14)/UART2TX/TSI1DATA5/TSODATA5/NFDATA5
        ...
        {_RIGHT_,    23,     51,    110,         MP_INV_V,  1},           //NC          |PORT19/TSI1SYNC/TSOSYNC
        {_RIGHT_,    38,     52,    120,         MP_INV_V,  2},           //NC          |PORT20/TSI2VALID/TSOVALID
        {_RIGHT_,    39,     53,    120,         MP_INV_V,  2},           //NC          |PORT21/TSI2DATA0/TSODATA0
        {_RIGHT_,    40,     54,    120,         MP_INV_V,  2},           //NC          |PORT22/TSI2DATA1/TSODATA1
        {_RIGHT_,    41,     55,    120,         MP_INV_V,  2},           //NC          |PORT23/TSI2DATA2/TSODATA2
        {_RIGHT_,    42,     56,    120,         MP_INV_V,  2},           //NC          |PORT24/TSI2DATA3/TSODATA3
        {_RIGHT_,    44,     57,    120,         MP_INV_V,  2},           //NC          |PORT25/TSI2DATA4/TSODATA4
        {_RIGHT_,    45,     58,    120,         MP_INV_V,  2},           //NC          |PORT26/TSI2DATA5/TSODATA5
        {_RIGHT_,    46,     59,    120,         MP_INV_V,  2},           //NC          |PORT27/TSI2DATA6/TSODATA6
        {_RIGHT_,    47,     60,    120,         MP_INV_V,  2},           //NC          |PORT28/TSI2DATA7/TSODATA7
        {_RIGHT_,    48,     61,    120,         MP_INV_V,  2},           //NC          |PORT29/TSI2SCLK/TSOCLK
        {_RIGHT_,    50,     62,    120,         MP_INV_V,  2},           //NC          |PORT30/TSI2SYNC/TSOSYNC
        ...
        {_TOP_,      86,     78,    MP_INV_V,    MP_INV_V,  1},           //NC          |PORT46/LINK_LED
        {_TOP_,      87,     79,    MP_INV_V,    MP_INV_V,  1},           //NC          |PORT47/ACT_LED
        {_LEFT_,     28,     85,    MP_INV_V,    MP_INV_V,  0},           //NC          |PORT64(GBPORT00)/SC1CLK
...
/*	{9 ,  1, GX_GPIO_CONFIG_VALID, GX_GPIO_OUTPUT, GX_GPIO_HIGH},
	...
	{21,  2, GX_GPIO_CONFIG_VALID, GX_GPIO_INPUT,  GX_GPIO_HIGH}, //CPU_TDO/LNB_SHORT LNB短路
	{22,  3, GX_GPIO_CONFIG_VALID, GX_GPIO_OUTPUT, GX_GPIO_HIGH}, //CPU_TMS/POWER_STANDBY POWER/STANDBY指示灯
	{23,  4, GX_GPIO_CONFIG_VALID, GX_GPIO_OUTPUT, GX_GPIO_HIGH}, //CPU_TCK
	...
	{27, 33, GX_GPIO_CONFIG_VALID, GX_GPIO_OUTPUT, GX_GPIO_HIGH}, //POWER_COUNT
	{28, 34, GX_GPIO_CONFIG_VALID, GX_GPIO_OUTPUT, GX_GPIO_HIGH}, //IR_RCU
	{103, 45, GX_GPIO_CONFIG_VALID, GX_GPIO_OUTPUT, GX_GPIO_LOW }, //CI/CA_SWITCH
	{133, 90, GX_GPIO_CONFIG_VALID, GX_GPIO_OUTPUT, GX_GPIO_LOW}, //CI_A00
	{132, 89, GX_GPIO_CONFIG_VALID, GX_GPIO_OUTPUT, GX_GPIO_LOW}, //CI_A01
	{131, 88, GX_GPIO_CONFIG_VALID, GX_GPIO_OUTPUT, GX_GPIO_LOW}, //CI_A02
	{130, 87, GX_GPIO_CONFIG_VALID, GX_GPIO_OUTPUT, GX_GPIO_LOW}, //CI_A03
	{128, 86, GX_GPIO_CONFIG_VALID, GX_GPIO_OUTPUT, GX_GPIO_LOW}, //CI_A04
	{129, 84, GX_GPIO_CONFIG_VALID, GX_GPIO_OUTPUT, GX_GPIO_LOW}, //CI_A05
	{126, 83, GX_GPIO_CONFIG_VALID, GX_GPIO_OUTPUT, GX_GPIO_LOW}, //CI_A06
	{127, 82, GX_GPIO_CONFIG_VALID, GX_GPIO_OUTPUT, GX_GPIO_LOW}, //CI_A07
	{125, 80, GX_GPIO_CONFIG_VALID, GX_GPIO_OUTPUT, GX_GPIO_LOW}, //CI_A08
	{124, 79, GX_GPIO_CONFIG_VALID, GX_GPIO_OUTPUT, GX_GPIO_LOW}, //CI_A09
	{134, 71, GX_GPIO_CONFIG_VALID, GX_GPIO_OUTPUT, GX_GPIO_LOW}, //CI_A10
	{135, 77, GX_GPIO_CONFIG_VALID, GX_GPIO_OUTPUT, GX_GPIO_LOW}, //CI_A11
	{117, 91, GX_GPIO_CONFIG_VALID, GX_GPIO_OUTPUT, GX_GPIO_LOW}, //CI_D00
	{116, 92, GX_GPIO_CONFIG_VALID, GX_GPIO_OUTPUT, GX_GPIO_LOW}, //CI_D01
	{118, 93, GX_GPIO_CONFIG_VALID, GX_GPIO_OUTPUT, GX_GPIO_LOW}, //CI_D02
	{123, 66, GX_GPIO_CONFIG_VALID, GX_GPIO_OUTPUT, GX_GPIO_LOW}, //CI_D03
	{122, 69, GX_GPIO_CONFIG_VALID, GX_GPIO_OUTPUT, GX_GPIO_LOW}, //CI_D04
	{121, 70, GX_GPIO_CONFIG_VALID, GX_GPIO_OUTPUT, GX_GPIO_LOW}, //CI_D05
	{119, 74, GX_GPIO_CONFIG_VALID, GX_GPIO_OUTPUT, GX_GPIO_LOW },//CI_D06
	{120, 73, GX_GPIO_CONFIG_VALID, GX_GPIO_OUTPUT, GX_GPIO_LOW }, //CI_D07
	{102, 85, GX_GPIO_CONFIG_VALID, GX_GPIO_OUTPUT, GX_GPIO_LOW}, //CI_RESET
	{113, 81, GX_GPIO_CONFIG_VALID, GX_GPIO_OUTPUT, GX_GPIO_HIGH}, //CI_WEN
	{111, 78, GX_GPIO_CONFIG_VALID, GX_GPIO_OUTPUT, GX_GPIO_HIGH}, //CI_JOWRN
	{110, 76, GX_GPIO_CONFIG_VALID, GX_GPIO_OUTPUT, GX_GPIO_HIGH}, //CI_JORDN
	{112, 75, GX_GPIO_CONFIG_VALID, GX_GPIO_OUTPUT, GX_GPIO_HIGH}, //CI_OEN
	{115, 72, GX_GPIO_CONFIG_VALID, GX_GPIO_OUTPUT, GX_GPIO_LOW }, //CI_CEN1
	{100, 65, GX_GPIO_CONFIG_VALID, GX_GPIO_INPUT, GX_GPIO_HIGH}, //CI_CDN1
 ...
 *(volatile unsigned int *)0x8a2036bc |= (1<<4);//ts out
