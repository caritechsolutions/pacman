...
//	{1, 8, GX_GPIO_CONFIG_VALID, GX_GPIO_OUTPUT, GX_GPIO_HIGH},// CLK for panel (fd650)
	{2, 5, GX_GPIO_CONFIG_VALID, GX_GPIO_OUTPUT, GX_GPIO_LOW},
	{3, 6, GX_GPIO_CONFIG_VALID, GX_GPIO_INPUT, GX_GPIO_LOW},
	{4, 9, GX_GPIO_CONFIG_VALID, GX_GPIO_INPUT, GX_GPIO_LOW},
    {5, 10, GX_GPIO_CONFIG_VALID, GX_GPIO_OUTPUT, GX_GPIO_HIGH},
