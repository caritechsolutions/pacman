...
struct mulpin_config_s mulpin_table[] = {
 ...
 /* chip_core_num | bit0 | bit1    | bit2       | func_select */   /* package_num | func_list */
        ...
        {5,         1,     45,       MP_INV_V,    0},              // NC          | DBGTDO_PORT01_ADCODATA1
        {6,         2,     46,       MP_INV_V,    0},              // NC          | DBGTMS_PORT02_ADCODATA2
        {7,         3,     47,       MP_INV_V,    0},              // NC          | DBGTCK_PORT03_ADCODATA3
        {8,         4,     48,       MP_INV_V,    0},              // NC          | DBGTRST_PORT04_ADCODATA4
#endif
        {26,        5,     32,       64,          1},              // NC          | SC1CLK_PORT05_TSI1DATA0_AJTDI_DVBFSYNC_ADCODATA5
        {27,        6,     33,       65,          1},              // NC          | SC1RST_PORT06_TSI1DATA1_AJTDO_ADCODATA6
        {28,        7,     34,       66,          0},              // NC          | SC1PWR_PORT07_TSI1DATA2_AJTMS_ADCODATA7
        {29,        8,     35,       67,          0},              // NC          | SC1CD_PORT08_TSI1DATA3_AJTCK_ADCODATA8
        ...
        {54,        14,    51,       MP_INV_V,    1},              // NC          | SDA1_PORT14_SDAT
        ...
        {126,       18,    49,       MP_INV_V,    1},              // NC          | DDCSDA_PORT18_SDAS
        {127,       19,    50,       MP_INV_V,    1},              // NC          | DDCSCL_PORT19_SCLS
...
#define COMMON_RESULT_GPIO     100
#define FE_RESULT_GPIO         101
#define PLAY_RESULT_GPIO       102
#define VPU_RESULT_GPIO        103
#define SMC_RESULT_GPIO        104
#define USB_RESULT_GPIO        105
#define NET_RESULT_GPIO        106
#define GA_RESULT_GPIO         107

struct gpio_entry_bootloader g_gpio_table[] = {
	{GA_RESULT_GPIO,  14, GX_GPIO_CONFIG_VALID, GX_GPIO_OUTPUT, GX_GPIO_HIGH},
	{VPU_RESULT_GPIO, 18, GX_GPIO_CONFIG_VALID, GX_GPIO_OUTPUT, GX_GPIO_HIGH},
	{USB_RESULT_GPIO, 19, GX_GPIO_CONFIG_VALID, GX_GPIO_OUTPUT, GX_GPIO_HIGH},
