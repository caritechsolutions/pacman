...
struct mulpin_config_s mulpin_table[] = {
 ...
 /* chip_core_num | bit0 | bit1    | bit2       | func_select */   /* package_num | func_list */
        {4,         0,     44,       MP_INV_V,    1},              // PORT00          | DBGTDI_PORT00_ADCODATA0
        {5,         1,     45,       MP_INV_V,    1},              // PORT01          | DBGTDO_PORT01_ADCODATA1
        {6,         2,     46,       MP_INV_V,    1},              // PORT02          | DBGTMS_PORT02_ADCODATA2
        {7,         3,     47,       MP_INV_V,    1},              // PORT03          | DBGTCK_PORT03_ADCODATA3
        ...
        {28,        7,     34,       66,          1},              // PORT07          | SC1PWR_PORT07_TSI1DATA2_AJTMS_ADCODATA7
        {29,        8,     35,       67,          1},              // PORT08            | SC1CD_PORT08_TSI1DATA3_AJTCK_ADCODATA8
        ...
        {54,        14,    51,       MP_INV_V,    0},              // NC          | SDA1_PORT14
        {55,        15,    52,       MP_INV_V,    0},              // NC          | SCL1_PORT15
        {56,        16,    41,       MP_INV_V,    0},              // NC          | UART1TX_PORT16_AUARTTX_HDMIDBT0
        {57,        17,    42,       MP_INV_V,    0},              // NC          | UART1RX_PORT17_HDMIDBT1
        {126,       18,    49,       MP_INV_V,    0},              // NC          | DDCSDA_PORT18
        {127,       19,    50,       MP_INV_V,    0},              // NC          | DDCSCL_PORT19
...
//        {0, 7, GX_GPIO_CONFIG_VALID, GX_GPIO_OUTPUT, GX_GPIO_HIGH},// SDA for panel (fd650)
//	{1, 8, GX_GPIO_CONFIG_VALID, GX_GPIO_OUTPUT, GX_GPIO_HIGH},// CLK for panel (fd650)
	{3,   5,  GX_GPIO_CONFIG_VALID, GX_GPIO_OUTPUT, GX_GPIO_LOW},
	{5,   1,  GX_GPIO_CONFIG_VALID, GX_GPIO_OUTPUT, GX_GPIO_HIGH}, // lnb power
	{10,   2,  GX_GPIO_CONFIG_VALID, GX_GPIO_OUTPUT, GX_GPIO_LOW}, // 13/18 select
	{11,   4,  GX_GPIO_CONFIG_VALID, GX_GPIO_OUTPUT, GX_GPIO_LOW}, // mxl683 disable
	{20,   6,  GX_GPIO_CONFIG_VALID, GX_GPIO_INPUT, GX_GPIO_HIGH},
	{21,   7,  GX_GPIO_CONFIG_VALID, GX_GPIO_INPUT, GX_GPIO_HIGH},
	{22,   8,  GX_GPIO_CONFIG_VALID, GX_GPIO_INPUT, GX_GPIO_HIGH},
...
extern int usb_recover_proc(void);
	...
	ts_mode_config(1, 1, 4, 0, 1, 1, 1);	//set ts1 to serial ts, and mode is 2, no valid, sync, little endian
	return 0;
}
