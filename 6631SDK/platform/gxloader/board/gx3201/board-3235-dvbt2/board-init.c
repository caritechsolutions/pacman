...
/*
 * hardware version: 3235_DEMO_V1.0  2014-03-24
 * */
...
struct mulpin_config_s mulpin_table[] = {
        ...
        { _RIGHT_,  30, 26, 75, 3},                             //RMRXD1_PORT26_GBDATA3
        { _RIGHT_,  31, 27, 75, 3},                             //RMRXD0_PORT27_GBDATA4
        ...
        { _RIGHT_,  76, 46, 79, 1},                             //AGC_PORT46_NFDATA0
        ...
        {   _TOP_,  84, 51, 72, 1},                             //NFCS3n_PORT51_RMCRSDV_HDMICEC
        {   _TOP_,  85, 52, 72, 1},                             //NFCS2n_PORT52_MD_NFRDY1
        {   _TOP_,  86, 53, 72, 1},                             //NFCS0n_PORT53_MDC

        {  _LEFT_,   1, 54, 72, 1},                             //NFCS1n_PORT54_RMTXEN
        {  _LEFT_,   2, 55, 72, 1},                             //NFWP_SC1CLK_RMTXD1
        {  _LEFT_,   3, 75, 72, 1},                             //NFDAT0_SC1RST_RMTXD0_GBADDR10
        {  _LEFT_,   4, 75, 72, 1},                             //NFDAT1_SC1PWR_RMCLK_GBADDR11
        {  _LEFT_,   5, 75, 72, 1},                             //NFDAT2_SC1CD_RMRXD1_GBADDR09
        {  _LEFT_,   6, 75, 72, 1},                             //NFDAT3_SC1DATA_RMRXD0_GBADDR08
        {  _LEFT_,  12, 75, MULPIN_INVALID_VALUE, 1},           //NFDAT4_GBADDR12
        {  _LEFT_,  13, 75, MULPIN_INVALID_VALUE, 1},           //NFDAT5_GBADDR07
        {  _LEFT_,  14, 75, 74, 3},                             //NFDAT6_AOPCMSD3_GBADDR06
        {  _LEFT_,  15, 75, 74, 3},                             //NFDAT7_AOPCMSD2_GBADDR05
        {  _LEFT_,  16, 75, 74, 3},                             //NFWE_AOPCMSD1_GBADDR04
        {  _LEFT_,  18, 75, 74, 3},                             //NFALE_AOPCMSD0_GBADDR03
        {  _LEFT_,  19, 75, 74, 3},                             //NFCLE_AOAMCLK_GBADDR02
        {  _LEFT_,  20, 75, 74, 3},                             //NFOE_AOPCMCLK_GBADDR01
        {  _LEFT_,  21, 75, 74, 3},                             //NFRDY0_AOPCMWS_GBADDR00

	{ARRAY_END_FLAG, ARRAY_END_FLAG, ARRAY_END_FLAG, ARRAY_END_FLAG, ARRAY_END_FLAG}
};

struct gpio_entry_bootloader g_gpio_table[] = {
	{46,53, GX_GPIO_CONFIG_VALID, GX_GPIO_OUTPUT,GX_GPIO_HIGH},//mute
	{54,54, GX_GPIO_CONFIG_VALID, GX_GPIO_OUTPUT,GX_GPIO_HIGH},//standby
	{10,10, GX_GPIO_CONFIG_VALID, GX_GPIO_OUTPUT, GX_GPIO_LOW},
	{11,11, GX_GPIO_CONFIG_VALID, GX_GPIO_INPUT, GX_GPIO_HIGH},//power key
	{12,12, GX_GPIO_CONFIG_VALID, GX_GPIO_INPUT, GX_GPIO_HIGH},//data
	{13,13, GX_GPIO_CONFIG_VALID, GX_GPIO_INPUT, GX_GPIO_HIGH},//clk
	{14,14, GX_GPIO_CONFIG_VALID, GX_GPIO_INPUT, GX_GPIO_LOW},//demo rst
	{44,44, GX_GPIO_CONFIG_VALID, GX_GPIO_INPUT, GX_GPIO_LOW},
