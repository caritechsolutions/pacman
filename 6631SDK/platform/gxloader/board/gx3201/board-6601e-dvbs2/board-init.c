...
/*
 * hardware version: dvbs-6601e_DEMO_V1.0  2014.03.24
 * */
...
struct mulpin_config_s mulpin_table[] = {
        ...
        { _RIGHT_,  68, 15, 69, 3},                             //UART2TX_PORT15_SDA2
        { _RIGHT_,  69, 16, 69, 3},                             //UART2RX_PORT16_SCL2
...
struct gpio_entry_bootloader g_gpio_table[] = {
   { 0, 20, GX_GPIO_CONFIG_VALID,  GX_GPIO_INPUT, GX_GPIO_LOW},
   { 1, 19, GX_GPIO_CONFIG_VALID, GX_GPIO_OUTPUT, GX_GPIO_LOW},
   { 3, 27, GX_GPIO_CONFIG_VALID, GX_GPIO_OUTPUT, GX_GPIO_HIGH}, //mute
   { 4, 21, GX_GPIO_CONFIG_VALID, GX_GPIO_OUTPUT, GX_GPIO_LOW}, //LNB2
   { 5, 22, GX_GPIO_CONFIG_VALID, GX_GPIO_OUTPUT, GX_GPIO_LOW}, //LNB1
   { 6, 31, GX_GPIO_CONFIG_VALID, GX_GPIO_OUTPUT, GX_GPIO_HIGH}, //tuner rst
   { 7, 28, GX_GPIO_CONFIG_VALID, GX_GPIO_OUTPUT, GX_GPIO_HIGH}, //net rst
