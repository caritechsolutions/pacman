...
/*
 * hardware version: dvbs-6601_DEMO_V1.0  2013.10.30
 * */
...
struct mulpin_config_s mulpin_table[] = {
        {_BOTTOM_,  74,  3, MULPIN_INVALID_VALUE, 0},           //SC1CLK_PORT03_SCICD
        {_BOTTOM_,  75,  4, MULPIN_INVALID_VALUE, 0},           //SC1RST_PORT04_SC2CLK
        {_BOTTOM_,  76,  5, MULPIN_INVALID_VALUE, 0},           //SC1PWR_PORT05_SCIC4
        {_BOTTOM_,  77,  6, MULPIN_INVALID_VALUE, 0},           //SC1CD_PORT06_SCI3V5V
        {_BOTTOM_,  78,  7, MULPIN_INVALID_VALUE, 0},           //SC1DATA_PORT07_SCICMDVCC
        {_BOTTOM_, 101,  8, 77, 0},                             //SPIHOLD_PORT08_NFRDY1
        ...
        { _RIGHT_,   5,  9, 77, 0},                             //SPIWP_PORT09_NFCS0n
#ifndef CONFIG_DBG_PIN_NO_MULTI
        { _RIGHT_,   7, 10, MULPIN_INVALID_VALUE, 1},           //DBGTDI_PORT10
        { _RIGHT_,   8, 11, MULPIN_INVALID_VALUE, 1},           //DBGTDO_PORT11
        { _RIGHT_,  10, 12, MULPIN_INVALID_VALUE, 1},           //DBGTMS_PORT12
        { _RIGHT_,  11, 13, MULPIN_INVALID_VALUE,1},            //DBGTCK_PORT13
        { _RIGHT_,  12, 14, MULPIN_INVALID_VALUE, 1},           //DBGTRST_PORT14
#endif
        { _RIGHT_,  21, 63, MULPIN_INVALID_VALUE, 0},           //GBCSn1_PORT63
        { _RIGHT_,  22, 19, 64, 0},                             //RMCRSDV_PORT19_AJTDI_GBCSn0
        { _RIGHT_,  23, 20, 64, 0},                             //MD_PORT20_AJTDO_GBDATA2
        { _RIGHT_,  24, 21, 64, 0},                             //MDC_PORT21_AJTMS_GBDATA1
        { _RIGHT_,  25, 22, 64, 0},                             //RMTXEN_PORT22_AJTCK_GBDATA0
        { _RIGHT_,  26, 23, 64, 0},                             //RMTXD1_PORT23_AJTRST_GBDATA7
        { _RIGHT_,  27, 24, 65, 0},                             //RMTXD0_PORT24_AOAMCLK_GBDATA6
        { _RIGHT_,  29, 25, 66, 0},                             //RMCLK_PORT25_AUARTTX_GBDATA5
        { _RIGHT_,  30, 26, 75, 0},                             //RMRXD1_PORT26_GBDATA3
        { _RIGHT_,  31, 27, 75, 0},                             //RMRXD0_PORT27_GBDATA4
        ...
        { _RIGHT_,  68, 15, 69, 0},                             //UART2TX_PORT15_SDA2
        { _RIGHT_,  69, 16, 69, 0},                             //UART2RX_PORT16_SCL2
        { _RIGHT_,  70, 17, 70, 0},                             //UART1TX_PORT17_AUARTTX
        { _RIGHT_,  71, 18, 70, 0},                             //UART1RX_PORT18
        { _RIGHT_,  72, 44, 80, 0},                             //HVSEL_PORT44_NFRDY0
        { _RIGHT_,  73, 45, 81, 0},                             //DiSEqCo_PORT45_NFCS1n
        ...
        {   _TOP_,  83, 50, MULPIN_INVALID_VALUE, 0},           //SPDIF_PORT50
        {   _TOP_,  84, 51, 72, 0},                             //NFCS3n_PORT51_RMCRSDV_HDMICEC
        {   _TOP_,  85, 52, 72, 0},                             //NFCS2n_PORT52_MD_NFRDY1
        {   _TOP_,  86, 53, 72, 0},                             //NFCS0n_PORT53_MDC

        {  _LEFT_,   1, 54, 72, 0},                             //NFCS1n_PORT54_RMTXEN
        {  _LEFT_,   2, 55, 72, 0},                             //NFWP_SC1CLK_RMTXD1
        {  _LEFT_,   3, 75, 72, 0},                             //NFDAT0_SC1RST_RMTXD0_GBADDR10
        {  _LEFT_,   4, 75, 72, 0},                             //NFDAT1_SC1PWR_RMCLK_GBADDR11
        {  _LEFT_,   5, 75, 72, 0},                             //NFDAT2_SC1CD_RMRXD1_GBADDR09
        {  _LEFT_,   6, 75, 72, 0},                             //NFDAT3_SC1DATA_RMRXD0_GBADDR08
...
/*	{9 ,  1, GX_GPIO_CONFIG_VALID, GX_GPIO_OUTPUT, GX_GPIO_HIGH},
	...
	{10, 19, GX_GPIO_CONFIG_VALID, GX_GPIO_OUTPUT, GX_GPIO_HIGH},
	{11, 11, GX_GPIO_CONFIG_VALID, GX_GPIO_OUTPUT, GX_GPIO_HIGH},
	{12, 20, GX_GPIO_CONFIG_VALID, GX_GPIO_OUTPUT, GX_GPIO_LOW},
	{13, 13, GX_GPIO_CONFIG_VALID, GX_GPIO_OUTPUT, GX_GPIO_HIGH},
	{14, 14, GX_GPIO_CONFIG_VALID, GX_GPIO_OUTPUT, GX_GPIO_LOW},
