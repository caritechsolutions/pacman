...
/*
 * hardware version: 3231-spi_DEMO_V1.0  2013.10.30
 * */
...
struct mulpin_config_s mulpin_table[] = {
        ...
        { _RIGHT_,  62, 38, 68, 1},                             //TSI1DATA4_PORT38_SC1CLK_NFDAT7
        { _RIGHT_,  63, 39, 68, 1},                             //TSI1DATA5_PORT39_SC1RST_NFDAT6
        { _RIGHT_,  64, 40, 68, 1},                             //TSI1DATA6_PORT40_SC1PWR_NFDAT5
        { _RIGHT_,  65, 41, 68, 1},                             //TSI1DATA7_PORT41_SC1CD_NFDAT4
        { _RIGHT_,  66, 42, 68, 1},                             //TSI1CLK_PORT42_SC1DATA_NFDATA3
        ...
        { _RIGHT_,  72, 44, 80, 3},                             //HVSEL_PORT44_NFRDY0
        { _RIGHT_,  73, 45, 81, 1},                             //DiSEqCo_PORT45_NFCS1n
        { _RIGHT_,  74, 78, 71, 3},                             //SDA1_NULL_SDAD_NFDATA2
        { _RIGHT_,  75, 78, 71, 3},                             //SCL1_NULL_SCLD_NFDATA1
        { _RIGHT_,  76, 46, 79, 3},                             //AGC_PORT46_NFDATA0
        ...
        {  _LEFT_,  14, 75, 74, 2},                             //NFDAT6_AOPCMSD3_GBADDR06
        {  _LEFT_,  15, 75, 74, 2},                             //NFDAT7_AOPCMSD2_GBADDR05
        {  _LEFT_,  16, 75, 74, 2},                             //NFWE_AOPCMSD1_GBADDR04
        {  _LEFT_,  18, 75, 74, 2},                             //NFALE_AOPCMSD0_GBADDR03
        {  _LEFT_,  19, 75, 74, 2},                             //NFCLE_AOAMCLK_GBADDR02
        {  _LEFT_,  20, 75, 74, 2},                             //NFOE_AOPCMCLK_GBADDR01
        {  _LEFT_,  21, 75, 74, 2},                             //NFRDY0_AOPCMWS_GBADDR00
