...
#if 0
	//GPIO 10 to control ddr reset
	*(volatile unsigned int*)0x0030a140 |= (1 << 10);
	*(volatile unsigned int*)0x0030a140 |= (1 << 10);
	*(volatile unsigned int*)0x00305000 |= (1 << 10);
	*(volatile unsigned int*)0x0030500c = (1 << 10);
#endif

#if 0
	//GPIO 34 to control ddr reset
	*(volatile unsigned int*)0x0030a144 |= (1 << (34-32));
	*(volatile unsigned int*)0x0030a148 &= ~(1 << 9);
	*(volatile unsigned int*)0x00306000 |= (1 << (34-32));
	*(volatile unsigned int*)0x0030600c |= (1 << (34-32));
#endif
	return;
}
...
#if 0
	//GPIO 10
	*(volatile unsigned int*)0x00305008 = (1 << 10);
#endif

#if 0
	//GPIO 34
	*(volatile unsigned int*)0x00306008 |= (1 << (34-32));
#endif
	return;
}
...
struct mulpin_config_s mulpin_table[] = {
        ...
        {  _LEFT_,  20, 75, 74, 0},                             //NFRE_AOPCMCLK_GBADDR01
...
int board_init(void)
{
	enable_dac(ENABLE_CVBS_AND_YPBPR);
	gpio_init();
	mulpin_init();
