...
/*
 * hardware version: dtmb-3201_DEMO_V1.0  2013.10.30
 * */
...
struct gpio_entry_bootloader g_gpio_table[] = {
	...
	{44, 44, GX_GPIO_CONFIG_VALID, GX_GPIO_OUTPUT, GX_GPIO_HIGH },
	{53, 53, GX_GPIO_CONFIG_VALID, GX_GPIO_OUTPUT, GX_GPIO_LOW },
