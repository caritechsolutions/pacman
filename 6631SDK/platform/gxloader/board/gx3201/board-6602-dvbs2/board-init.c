...
/*
 * hardware version: dvbs-6602_DEMO_V1.0  2013.10.30
 * */
...
struct gpio_entry_bootloader g_gpio_table[] = {
   ...
   {3, 27, GX_GPIO_CONFIG_VALID, GX_GPIO_OUTPUT, GX_GPIO_LOW},
   {4, 21, GX_GPIO_CONFIG_VALID, GX_GPIO_OUTPUT, GX_GPIO_HIGH}, //LNB2
   {5, 22, GX_GPIO_CONFIG_VALID, GX_GPIO_OUTPUT, GX_GPIO_HIGH}, //LNB1
   {6, 31, GX_GPIO_CONFIG_VALID, GX_GPIO_OUTPUT, GX_GPIO_LOW}, //tuner rst
   {7, 28, GX_GPIO_CONFIG_VALID, GX_GPIO_OUTPUT, GX_GPIO_LOW}, //net rst
   {8, 29, GX_GPIO_CONFIG_VALID, GX_GPIO_OUTPUT, GX_GPIO_HIGH}, //usb
   {9, 30, GX_GPIO_CONFIG_VALID, GX_GPIO_OUTPUT, GX_GPIO_HIGH}, //usb
...
extern int usb_recover_proc(void);
    ...
    *(volatile unsigned int*)0xa0305008 = (1<<31);
    for(i = 0; i < 1000000; i++);
    *(volatile unsigned int*)0xa030500c = (1<<31);
    for(i = 0; i < 2000000; i++);
    *(volatile unsigned int*)0xa0305008 = (1<<31);
    *(volatile unsigned int*)0xa0305008 = (1<<28);
	return 0;
}
