...
typedef int                       GxMsgProperty_PlayerVideoInterface;//SAMPLE:GX_VIDEO_OUTPUT_RCA|GX_VIDEO_OUTPUT_VGA
...
typedef struct {
	AudioAACMode                  mode;
}GxMsgProperty_PlayerAudioAACMode;
...
typedef PlayerPlayPVRConfig		  GxMsgProperty_PlayerPlayPVRConfig;
...
typedef PlayerEventVideoDynamicRangeChanged GxMsgProperty_PlayerVideoDynamicRangeChanged;
...
typedef struct {
	const char*                   player;
	int                           delayms;
} GxMsgProperty_PlayerAudioDelay;

typedef struct {
	const char*                   player;
	int                           delayms;
} GxMsgProperty_PlayerVideoDelay;
