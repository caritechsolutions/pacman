...
/* Error Constants -----------------------------------------------------------*/
#define GxSiDes_Trace(...) //gxlogd("%s",__FUNCTION__)
/* Exported Types --------------------------------------------------------- */
/**
 *   si common info
 */
...
/* component descriptor information storage structure */
typedef struct component_des_info{
	uint8_t *text;                 /* description of the component stream */
...
typedef struct service_info {
	...
	component_info_t component_info;         /* component descriptor information storage structure */
...
#define	SI_EIT_BUF_SIZE			(4*1024+ADDITIONAL_SIZE*7)
