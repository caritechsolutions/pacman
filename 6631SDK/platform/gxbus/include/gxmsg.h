...
/**服务总线支持最大消息数量*/
#define GXMSG_MAX_NUM_SUPPORT               (350)
...
typedef enum {
	...
	GXMSG_EPG_NUM_GET,
	GXMSG_EPG_GET,
	GXMSG_EPG_NUM_GET_BY_PERIOD,
	GXMSG_EPG_PF_NUM_GET,
	GXMSG_EPG_PF_GET,
	GXMSG_EPG_GET_BY_PERIOD,
	GXMSG_EPG_GET_BY_EVENT_ID,
	GXMSG_EPG_NVOD_GET,
	GXMSG_EPG_CREATE,
	GXMSG_EPG_CLEAN,
	GXMSG_EPG_RELEASE,
	GXMSG_EPG_SECTION_FLAG_RELEASE,
	...
	GXMSG_EPG_CFG_GET,      /*携带的参数为GxMsgProperty_EpgCreate*/
	GXMSG_EPG_FILTER_START, /*携带的参数为GxMsgProperty_EpgCreate*/
	GXMSG_EPG_FILTER_STOP,
	GXMSG_EPG_FULL,
	GXMSG_EPG_EXIST,
	GXMSG_EPG_TIMEOUT,
	GXMSG_EPG_FULL_SPEED,
	GXMSG_EPG_RESET,
	GXMSG_EPG_DETAIL_FILTER_SET,
	GXMSG_EPG_DETAIL_FILTER_CLEAN,
	GXMSG_BOOK_TRIGGER,
	GXMSG_BOOK_FINISH,
	GXMSG_BOOK_GET,
	GXMSG_BOOK_CREATE,
	...
	GXMSG_GUI_TRANSFER_MESSAGE,
	GXMSG_GUI_ACKNOWLEDGE_MESSAGE,
	...
	GXMSG_HOTPLUG_DETECT,
	GXMSG_HOTPLUG_IN_FAILED_NO_PARTITION,
	GXMSG_HOTPLUG_IN_FAILED_MOUNT_FAILED,
	GXMSG_HOTPLUG_IN,
	GXMSG_HOTPLUG_OUT,
	GXMSG_HOTPLUG_CLEAN,
	...
	GXMSG_HDMI_VERSION_INFO,
	GXMSG_HDMI_RXSENSE_OK,
	GXMSG_HDMI_RXSENSE_ERROR,

	GXMSG_USBWIFI_HOTPLUG_IN,
	GXMSG_USBWIFI_HOTPLUG_OUT,
	GXMSG_USBWIFI_STATUS,
	GXMSG_USBWIFI_SCAN_END,

	GXMSG_USB3G_HOTPLUG_IN,
	GXMSG_USB3G_HOTPLUG_OUT,

	GXMSG_ETH_HOTPLUG_IN,
	GXMSG_ETH_HOTPLUG_OUT,

	GXMSG_USBNET_HOTPLUG_IN,
	GXMSG_USBNET_HOTPLUG_OUT,
	GXMSG_USBNET_STATUS,

	GXMSG_USBSERIAL_HOTPLUG_IN,
	GXMSG_USBSERIAL_HOTPLUG_OUT,

	GXMSG_USBBT_HOTPLUG_IN,
	GXMSG_USBBT_HOTPLUG_OUT,

	GXMSG_USBBT_INIT_SUCCESS,
	GXMSG_USBBT_SCAN_RESULT,
	GXMSG_USBBT_SCAN_FINISH,
	GXMSG_USBBT_LINK_KEY_NOTIFY,
	GXMSG_USBBT_SINK_CONNECT,
	GXMSG_USBBT_SINK_CONNECT_FAILED,
	GXMSG_USBBT_SINK_DISCONNECT,
	GXMSG_USBBT_SINK_PLAY,
	GXMSG_USBBT_SINK_PAUSE,
	GXMSG_USBBT_SINK_PLAYING_TITLE_INFO,
	GXMSG_USBBT_SINK_PLAYING_ARTIST_INFO,
	GXMSG_USBBT_SINK_PLAYING_ALBUM_INFO,
	GXMSG_USBBT_SINK_TRACK_CHANGED,  // After receiving this event, GxCore_BTSinkGetPlayingInfo can be called to obtain the latest lyrics, author, and song title information

	GXMSG_USBBT_SOURCE_CONNECT,
	GXMSG_USBBT_SOURCE_CONNECT_FAILED,
	GXMSG_USBBT_SOURCE_DISCONNECT,
	GXMSG_USBBT_SOURCE_PLAY,
	GXMSG_USBBT_SOURCE_PAUSE,
	GXMSG_USBBT_SOURCE_STREAM_ESTABLISHED,
	GXMSG_USBBT_SOURCE_STREAM_RELEASED,

	GXMSG_USBAUDIO_HOTPLUG_IN,
	GXMSG_USBAUDIO_HOTPLUG_OUT,

	GXMSG_USBHID_HOTPLUG_IN,
	GXMSG_USBHID_HOTPLUG_OUT,

	GXMSG_USBUVC_HOTPLUG_IN,
	GXMSG_USBUVC_HOTPLUG_OUT,
	...
	GXMSG_CHIPTEST_MACV_SET_PARAM,
	GXMSG_CHIPTEST_MACV_GET_PARAM,
	GXMSG_CHIPTEST_MACV_DUMP_REG,
