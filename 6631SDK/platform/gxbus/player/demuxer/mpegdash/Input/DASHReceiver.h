...
namespace libdash
{
	namespace framework
	{
		namespace input
		{
			...
			{
			public:
				DASHReceiver            (dash::mpd::IMPD *mpd, IDASHReceiverObserver *obs, buffer::MediaObjectBuffer *buffer, uint32_t bufferSize, PLAYER_INTERRUPT_CBK _interruptcbk);
				...
				PLAYER_INTERRUPT_CBK        dashReceiverInterruptcbk;
			private:
