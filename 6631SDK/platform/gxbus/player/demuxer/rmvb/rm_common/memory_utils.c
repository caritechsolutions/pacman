...
HX_RESULT rm_enforce_buffer_min_size(void* pUserMem,
				     ...
				     rm_free_func_ptr fpFree, BYTE* * ppBuf, UINT32 * pulCurLen, UINT32 ulReqLen)
{
...
BYTE* copy_buffer(void *pUserMem, rm_av_malloc_func_ptr fpMalloc, BYTE * pBuf, UINT32 ulLen)
{
	BYTE* pRet = HXNULL;
