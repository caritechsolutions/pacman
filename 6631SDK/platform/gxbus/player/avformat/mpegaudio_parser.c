...
//#include "../avformat/apetag.h" // for APE tag.
#include "../avformat/id3v1.h" // for ID3v1_TAG_SIZE
            ...
            while(i<buf_size){
                ...
                if (ret < 4) {
                    ...
                    if (s1->flags & PARSER_FLAG_COMPLETE_FRAMES) {
                        s->frame_size = 0;
                        next = buf_size;
                    } else if (codec_id == CODEC_ID_MP3ADU) {
                        *poutbuf = NULL;
                        *poutbuf_size = 0;
...
AVCodecParser ff_mpegaudio_parser = {
    .codec_ids      = { CODEC_ID_MP1, CODEC_ID_MP2, CODEC_ID_MP3, CODEC_ID_MP3ADU },
