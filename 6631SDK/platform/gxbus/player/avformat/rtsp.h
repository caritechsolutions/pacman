...
typedef struct RTSPState {
    ...
    char last_subscription[128];/*from the ff_rdt_subscribe_rule function, it  last_subscription size <  128*/
    //@}
 ...
 */
typedef struct RTSPStreamQueue {
...
typedef struct RTSPStream {
	...
	RTSPStreamQueue *rtp_queue;
	unsigned short   rtp_queue_max;
	unsigned short   rtp_queue_count;
	unsigned short   rtp_queue_rd;
	char             rtp_queue_inited;
