...
const AVCodecTag mp4_obj_type[] = {
    ...
    { CODEC_ID_OPUS      , 0xAD }, /* mp4ra.org */
    { CODEC_ID_VP9       , 0xB1 }, /* mp4ra.org */
    { CODEC_ID_FLAC      , 0xC1 }, /* nonstandard, update when there is a standard value */
...
/*  { CODEC_ID_MJPEG,  MKTAG('A', 'V', 'R', 'n') },*//* MJPEG with alpha-channel (AVID ABVB/Truevision NuVista) */
    ...
    { CODEC_ID_H264, MKTAG('a', 'v', 'c', '2') }, /* AVC-2/H.264*/
    { CODEC_ID_H264, MKTAG('a', 'v', 'c', '3') }, /* AVC-3/H.264*/
    { CODEC_ID_H264, MKTAG('a', 'v', 'c', '4') }, /* AVC-4/H.264*/
...
/*  { CODEC_ID_OGG_VORBIS, MKTAG('O', 'g', 'g', 'S') },*//* sample files at http://heroinewarrior.com/xmovie.php3 use this tag */
    ...
    { CODEC_ID_DTS,  MKTAG('d', 't', 's', 'e') }, /* DTS Express */
    ...
    { CODEC_ID_FLAC,  MKTAG('f', 'L', 'a', 'C') }, /* nonstandard */
    { CODEC_ID_OPUS,  MKTAG('O', 'p', 'u', 's') }, /* mp4ra.org */
    { CODEC_ID_NONE, 0 },
};

const AVCodecTag codec_movsubtitle_tags[] = {
    { CODEC_ID_MOV_TEXT, MKTAG('t', 'e', 'x', 't') },
    { CODEC_ID_MOV_TEXT, MKTAG('t', 'x', '3', 'g') },
    { CODEC_ID_NONE, 0 },
};

const AVCodecTag codec_movdata_tags[] = {
    { CODEC_ID_BIN_DATA, MKTAG('g', 'p', 'm', 'd') },
    { CODEC_ID_NONE, 0 },
};
...
int mov_iso639_to_lang(const char* lang, int mp4)
{
    int i, code = 0;
...
int mov_lang_to_iso639(unsigned code, char* to)
{
    int i;
