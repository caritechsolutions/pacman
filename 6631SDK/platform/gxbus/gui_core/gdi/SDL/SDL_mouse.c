...
#ifdef SAVE_RCSID
static char rcsid = "@(#) $Id: SDL_mouse.c,v 1.8 2004/08/21 12:38:50 slouken Exp $";
#endif
...
static void ClipOffset(Sint16 * x, Sint16 * y)
{
	...
	if (SDL_VideoSurface->offset) {
		...
		*x -= (SDL_VideoSurface->offset % SDL_VideoSurface->pitch) / SDL_VideoSurface->format->BytesPerPixel;
	}
}
