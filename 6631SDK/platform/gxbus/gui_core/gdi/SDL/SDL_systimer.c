...
#ifdef SAVE_RCSID
static char rcsid = "@(#) $Id: SDL_systimer.c,v 1.10 2004/01/04 16:49:19 slouken Exp $";
#endif
...
static float calc_cpu_mhz(void)
{
	...
	usec_delay = 1000000L * (tv_end.tv_sec - tv_start.tv_sec) + (tv_end.tv_usec - tv_start.tv_usec);
