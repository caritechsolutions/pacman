...
#ifdef SAVE_RCSID
static char rcsid = "@(#) $Id: SDL_fbmatrox.c,v 1.8 2004/01/04 16:49:25 slouken Exp $";
#endif
...
static int FillHWRect(_THIS, SDL_Surface * dst, SDL_Rect * rect, Uint32 color)
{
	...
	fillop = MGADWG_TRAP | MGADWG_SOLID | MGADWG_ARZERO | MGADWG_SGNZERO | MGADWG_SHIFTZERO;
...
static int HWAccelBlit(SDL_Surface * src, SDL_Rect * srcrect, SDL_Surface * dst, SDL_Rect * dstrect)
{
	...
	if ((src->flags & SDL_SRCCOLORKEY) == SDL_SRCCOLORKEY) {
		...
		blitop = MGADWG_BFCOL | MGADWG_BITBLT | MGADWG_SHIFTZERO | MGADWG_RSTR | (0x0C << 16) | MGADWG_TRANSC;
		...
		blitop = MGADWG_BFCOL | MGADWG_BITBLT | MGADWG_SHIFTZERO | MGADWG_RSTR | (0x0C << 16);
	}
	mga_wait(7);
