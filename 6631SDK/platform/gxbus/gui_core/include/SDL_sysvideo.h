...
extern SDL_VideoDevice *gx_current_video;

#define SDL_VideoSurface	(gx_current_video->screen)
#define SDL_ShadowSurface	(gx_current_video->shadow)
#define SDL_PublicSurface	(gx_current_video->visible)
