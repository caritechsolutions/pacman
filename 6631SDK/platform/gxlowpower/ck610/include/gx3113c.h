...
* Type      :   csky
******************************************************************************
* Purpose   :   the head file of GX3201 in low-power mode
*****************************************************************************/
#ifndef __GX3113C_H__
#define __GX3113C_H__
...
#define GXCHIP_TYPE                       GXCHIP_TYPE_GX3113C
...
/* Define some base address of the registers in GX3201 */
...
#define rMULPIN0_CONFIG             (*(volatile U32 *)(CONFIG_BASE_ADDR + 0x140))
#define rMULPIN2_CONFIG             (*(volatile U32 *)(CONFIG_BASE_ADDR + 0x148))
