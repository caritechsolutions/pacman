...
#define GXOTA_PANEL_CLK_GPIO      36
#define GXOTA_PANEL_DATA_GPIO     35
#define GXOTA_PANEL_STANDBY_GPIO  34
...
static uint32_t gx_stb_panel_ct1642_config(void)
{
	...
	g_PanelCT1642Config.m_chClkPin = GXOTA_PANEL_CLK_GPIO;//36;//23;
	g_PanelCT1642Config.m_chDataPin = GXOTA_PANEL_DATA_GPIO;//35;//22;
	g_PanelCT1642Config.m_chKeyPin[0] = GXOTA_PANEL_STANDBY_GPIO;//34;
	g_PanelCT1642Config.m_chKeyPin[1] = GXOTA_PANEL_STANDBY_GPIO;//34;
	g_PanelCT1642Config.m_chLockPin = GXOTA_PANEL_LOCK_GPIO;//33;//24;
